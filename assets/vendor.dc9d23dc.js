 ...
 * limitations under the License.
 */
const Yl={};function Jl(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Yi("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Gi("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=El(s,r),c=l.repoInfo;"undefined"!=typeof process&&(a=process.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=El(s,r),c=l.repoInfo):o=!l.repoInfo.secure;const h=r&&o?new pr(pr.OWNER):new dr(e.name,e.options,t);Xa("Invalid Firebase Database URL",l),jr(l.path)||Yi("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=Yl[t.name];r||(r={},Yl[t.name]=r);let s=r[e.toURLString()];s&&Yi("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new sl(e,false,n,i),r[e.toURLString()]=s,s}(c,e,h,new ur(e.name,n));return new Ql(u,e)}class Ql{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(ol(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Nl(this._repo,Or())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Yl[t];n&&n[e.key]===e||Yi(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Yi("Cannot call "+e+" on a deleted database.")}}function Xl(e=lt(),t){return rt(e,"database").getImmediate({identifier:t})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const Zl={".sv":"timestamp"};function ec(){return Zl}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var tc,nc;Kr.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Kr.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){Di="9.0.0",it(new qe("database",((e,{instanceIdentifier:t})=>Jl(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ct("@firebase/database","0.12.0",e)}(),(nc=tc||(tc={}))[nc.NO_ERROR=0]="NO_ERROR",nc[nc.NETWORK_ERROR=1]="NETWORK_ERROR",nc[nc.ABORT=2]="ABORT";class ic extends me{constructor(e,t){super(rc(e),`Firebase Storage: ${t} (${rc(e)})`),this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,ic.prototype)}_codeEquals(e){return rc(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}function rc(e){return"storage/"+e}function sc(){return new ic("unknown","An unknown error occurred, please check the error payload for server response.")}function oc(e){return new ic("invalid-argument",e)}function ac(){return new ic("app-deleted","The Firebase app was deleted.")}function lc(e,t){return new ic("invalid-format","String does not match format '"+e+"': "+t)}function cc(e){throw new ic("internal-error","Internal error: "+e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hc{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.errorCode_=tc.NO_ERROR,this.sendPromise_=new Promise((e=>{this.xhr_.addEventListener("abort",(()=>{this.errorCode_=tc.ABORT,e()})),this.xhr_.addEventListener("error",(()=>{this.errorCode_=tc.NETWORK_ERROR,e()})),this.xhr_.addEventListener("load",(()=>{e()}))}))}send(e,t,n,i){if(this.sent_)throw cc("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(t,e,!0),void 0!==i)for(const r in i)i.hasOwnProperty(r)&&this.xhr_.setRequestHeader(r,i[r].toString());return void 0!==n?this.xhr_.send(n):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw cc("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw cc("cannot .getStatus() before sending");try{return this.xhr_.status}catch(e){return-1}}getResponseText(){if(!this.sent_)throw cc("cannot .getResponseText() before sending");return this.xhr_.responseText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.removeEventListener("progress",e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class uc{createConnection(){return new hc}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=dc.makeFromUrl(e,t)}catch(i){return new dc(e,"")}if(""===n.path)return n;throw new ic("invalid-default-bucket","Invalid default bucket '"+e+"'.")}static makeFromUrl(e,t){let n=null;const i="([A-Za-z0-9.\\-_]+)";const r=new RegExp("^gs://"+i+"(/(.*))?$","i");function s(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:r,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${i}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:s},{regex:new RegExp(`^https?://${"firebasestorage.googleapis.com"===t?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${i}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:s}];for(let l=0;l<a.length;l++){const t=a[l],i=t.regex.exec(e);if(i){const e=i[t.indices.bucket];let r=i[t.indices.path];r||(r=""),n=new dc(e,r),t.postModify(n);break}}if(null==n)throw function(e){return new ic("invalid-url","Invalid URL '"+e+"'.")}(e);return n}}class pc{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fc(e){return"string"==typeof e||e instanceof String}function _c(e){return gc()&&e instanceof Blob}function gc(){return"undefined"!=typeof Blob}function mc(e,t,n,i){if(i<t)throw oc(`Invalid value for '${e}'. Expected ${t} or greater.`);if(i>n)throw oc(`Invalid value for '${e}'. Expected ${n} or less.`)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(e,t){const n=t.match(/^(\w+):\/\/.+/);let i=t;return null==(null==n?void 0:n[1])&&(i=`https://${t}`),`${i}/v0${e}`}function vc(e){const t=encodeURIComponent;let n="?";for(const i in e)if(e.hasOwnProperty(i)){n=n+(t(i)+"="+t(e[i]))+"&"}return n=n.slice(0,-1),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wc{constructor(e,t,n,i,r,s,o,a,l,c,h){this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.url_=e,this.method_=t,this.headers_=n,this.body_=i,this.successCodes_=r.slice(),this.additionalRetryCodes_=s.slice(),this.callback_=o,this.errorCallback_=a,this.progressCallback_=c,this.timeout_=l,this.pool_=h,this.promise_=new Promise(((e,t)=>{this.resolve_=e,this.reject_=t,this.start_()}))}start_(){const e=this;function t(t,n){const i=e.resolve_,r=e.reject_,s=n.connection;if(n.wasSuccessCode)try{const t=e.callback_(s,s.getResponseText());void 0!==t?i(t):i()}catch(o){r(o)}else if(null!==s){const t=sc();t.serverResponse=s.getResponseText(),e.errorCallback_?r(e.errorCallback_(s,t)):r(t)}else if(n.canceled){r(e.appDelete_?ac():new ic("canceled","User canceled the upload/download."))}else{r(new ic("retry-limit-exceeded","Max retry time for operation exceeded, please try again."))}}this.canceled_?t(0,new bc(!1,null,!0)):this.backoffId_=function(e,t,n){let i=1,r=null,s=!1,o=0;function a(){return 2===o}let l=!1;function c(...e){l||(l=!0,t.apply(null,e))}function h(t){r=setTimeout((()=>{r=null,e(u,a())}),t)}function u(e,...t){if(l)return;if(e)return void c.call(null,e,...t);if(a()||s)return void c.call(null,e,...t);let n;i<64&&(i*=2),1===o?(o=2,n=0):n=1e3*(i+Math.random()),h(n)}let d=!1;function p(e){d||(d=!0,l||(null!==r?(e||(o=2),clearTimeout(r),h(0)):e||(o=1)))}return h(0),setTimeout((()=>{s=!0,p(!0)}),n),p}((function(t,n){if(n)return void t(!1,new bc(!1,null,!0));const i=e.pool_.createConnection();function r(t){const n=t.loaded,i=t.lengthComputable?t.total:-1;null!==e.progressCallback_&&e.progressCallback_(n,i)}e.pendingConnection_=i,null!==e.progressCallback_&&i.addUploadProgressListener(r),i.send(e.url_,e.method_,e.body_,e.headers_).then((()=>{null!==e.progressCallback_&&i.removeUploadProgressListener(r),e.pendingConnection_=null;const n=i.getErrorCode()===tc.NO_ERROR,s=i.getStatus();if(!n||e.isRetryStatusCode_(s)){const e=i.getErrorCode()===tc.ABORT;return void t(!1,new bc(!1,null,e))}const o=-1!==e.successCodes_.indexOf(s);t(!0,new bc(o,i))}))}),t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,null!==this.backoffId_&&(0,this.backoffId_)(!1),null!==this.pendingConnection_&&this.pendingConnection_.abort()}isRetryStatusCode_(e){const t=e>=500&&e<600,n=-1!==[408,429].indexOf(e),i=-1!==this.additionalRetryCodes_.indexOf(e);return t||n||i}}class bc{constructor(e,t,n){this.wasSuccessCode=e,this.connection=t,this.canceled=!!n}}function Cc(...e){const t="undefined"!=typeof BlobBuilder?BlobBuilder:"undefined"!=typeof WebKitBlobBuilder?WebKitBlobBuilder:void 0;if(void 0!==t){const n=new t;for(let t=0;t<e.length;t++)n.append(e[t]);return n.getBlob()}if(gc())return new Blob(e);throw new ic("unsupported-environment","This browser doesn't seem to support creating Blobs")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ic="raw",kc="base64",Ec="base64url",Tc="data_url";class Sc{constructor(e,t){this.data=e,this.contentType=t||null}}function xc(e,t){switch(e){case Ic:return new Sc(Rc(t));case kc:case Ec:return new Sc(Pc(e,t));case Tc:return new Sc(function(e){const t=new Nc(e);return t.base64?Pc(kc,t.rest):function(e){let t;try{t=decodeURIComponent(e)}catch(n){throw lc(Tc,"Malformed data URL.")}return Rc(t)}(t.rest)}(t),new Nc(t).contentType)}throw sc()}function Rc(e){const t=[];for(let n=0;n<e.length;n++){let i=e.charCodeAt(n);if(i<=127)t.push(i);else if(i<=2047)t.push(192|i>>6,128|63&i);else if(55296==(64512&i)){if(n<e.length-1&&56320==(64512&e.charCodeAt(n+1))){i=65536|(1023&i)<<10|1023&e.charCodeAt(++n),t.push(240|i>>18,128|i>>12&63,128|i>>6&63,128|63&i)}else t.push(239,191,189)}else 56320==(64512&i)?t.push(239,191,189):t.push(224|i>>12,128|i>>6&63,128|63&i)}return new Uint8Array(t)}function Pc(e,t){switch(e){case kc:{const n=-1!==t.indexOf("-"),i=-1!==t.indexOf("_");if(n||i){throw lc(e,"Invalid character '"+(n?"-":"_")+"' found: is it base64url encoded?")}break}case Ec:{const n=-1!==t.indexOf("+"),i=-1!==t.indexOf("/");if(n||i){throw lc(e,"Invalid character '"+(n?"+":"/")+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=atob(t)}catch(r){throw lc(e,"Invalid character found")}const i=new Uint8Array(n.length);for(let s=0;s<n.length;s++)i[s]=n.charCodeAt(s);return i}class Nc{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw lc(Tc,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=function(e,t){if(!(e.length>=t.length))return!1;return e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-";base64".length):n),this.rest=e.substring(e.indexOf(",")+1)}}class Oc{constructor(e,t){let n=0,i="";_c(e)?(this.data_=e,n=e.size,i=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,t){if(_c(this.data_)){const s=this.data_,o=(i=e,r=t,(n=s).webkitSlice?n.webkitSlice(i,r):n.mozSlice?n.mozSlice(i,r):n.slice?n.slice(i,r):null);return null===o?null:new Oc(o)}{const n=new Uint8Array(this.data_.buffer,e,t-e);return new Oc(n,!0)}var n,i,r;
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}static getBlob(...e){if(gc()){const t=e.map((e=>e instanceof Oc?e.data_:e));return new Oc(Cc.apply(null,t))}{const t=e.map((e=>fc(e)?xc(Ic,e).data:e.data_));let n=0;t.forEach((e=>{n+=e.byteLength}));const i=new Uint8Array(n);let r=0;return t.forEach((e=>{for(let t=0;t<e.length;t++)i[r++]=e[t]})),new Oc(i,!0)}}uploadData(){return this.data_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ac(e){let t;try{t=JSON.parse(e)}catch(i){return null}return"object"!=typeof(n=t)||Array.isArray(n)?null:t;var n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mc(e,t){return t}class Lc{constructor(e,t,n,i){this.server=e,this.local=t||e,this.writable=!!n,this.xform=i||Mc}}let Fc=null;function Uc(){if(Fc)return Fc;const e=[];e.push(new Lc("bucket")),e.push(new Lc("generation")),e.push(new Lc("metageneration")),e.push(new Lc("name","fullPath",!0));const t=new Lc("name");t.xform=function(e,t){return function(e){return!fc(e)||e.length<2?e:Dc(e)}(t)},e.push(t);const n=new Lc("size");return n.xform=function(e,t){return void 0!==t?Number(t):t},e.push(n),e.push(new Lc("timeCreated")),e.push(new Lc("updated")),e.push(new Lc("md5Hash",null,!0)),e.push(new Lc("cacheControl",null,!0)),e.push(new Lc("contentDisposition",null,!0)),e.push(new Lc("contentEncoding",null,!0)),e.push(new Lc("contentLanguage",null,!0)),e.push(new Lc("contentType",null,!0)),e.push(new Lc("metadata","customMetadata",!0)),Fc=e,Fc}function qc(e,t,n){const i={type:"file"},r=n.length;for(let s=0;s<r;s++){const e=n[s];i[e.local]=e.xform(i,t[e.server])}return function(e,t){Object.defineProperty(e,"ref",{get:function(){const n=e.bucket,i=e.fullPath,r=new dc(n,i);return t._makeStorageReference(r)}})}(i,e),i}function jc(e,t,n){const i=Ac(t);if(null===i)return null;return qc(e,i,n)}class Wc{constructor(e,t,n,i){this.url=e,this.method=t,this.handler=n,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(e){if(!e)throw sc()}function Bc(e,t){return function(n,i){const r=jc(e,i,t);return zc(null!==r),function(e,t,n){const i=Ac(t);if(null===i)return null;if(!fc(i.downloadTokens))return null;const r=i.downloadTokens;if(0===r.length)return null;const s=encodeURIComponent;return r.split(",").map((t=>{const i=e.bucket,r=e.fullPath;return yc("/b/"+s(i)+"/o/"+s(r),n)+vc({alt:"media",token:t})}))[0]}(r,i,e.host)}}function Vc(e){return function(t,n){let i;var r,s;return 401===t.getStatus()?i=t.getResponseText().includes("Firebase App Check token is invalid")?new ic("unauthorized-app","This app does not have permission to access Firebase Storage on this project."):new ic("unauthenticated","User is not authenticated, please authenticate using Firebase Authentication and try again."):402===t.getStatus()?(s=e.bucket,i=new ic("quota-exceeded","Quota for bucket '"+s+"' exceeded, please view quota on https://firebase.google.com/pricing/.")):403===t.getStatus()?(r=e.path,i=new ic("unauthorized","User does not have permission to access '"+r+"'.")):i=n,i.serverResponse=n.serverResponse,i}}function Hc(e){const t=Vc(e);return function(n,i){let r=t(n,i);var s;return 404===n.getStatus()&&(s=e.path,r=new ic("object-not-found","Object '"+s+"' does not exist.")),r.serverResponse=i.serverResponse,r}}function Gc(e,t,n,i,r){const s=t.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};const a=function(){let e="";for(let t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}();o["Content-Type"]="multipart/related; boundary="+a;const l=function(e,t,n){const i=Object.assign({},n);return i.fullPath=e.path,i.size=t.size(),i.contentType||(i.contentType=function(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}(null,t)),i}(t,i,r),c="--"+a+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+function(e,t){const n={},i=t.length;for(let r=0;r<i;r++){const i=t[r];i.writable&&(n[i.server]=e[i.local])}return JSON.stringify(n)}(l,n)+"\r\n--"+a+"\r\nContent-Type: "+l.contentType+"\r\n\r\n",h="\r\n--"+a+"--",u=Oc.getBlob(c,i,h);if(null===u)throw new ic("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.");const d={name:l.fullPath},p=yc(s,e.host),f=e.maxUploadRetryTime,_=new Wc(p,"POST",function(e,t){return function(n,i){const r=jc(e,i,t);return zc(null!==r),r}}(e,n),f);return _.urlParams=d,_.headers=o,_.body=u.uploadData(),_.errorHandler=Vc(t),_}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $c{constructor(e,t){this._service=e,this._location=t instanceof dc?t:dc.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new $c(e,t)}get root(){const e=new dc(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Dc(this._location.path)}get storage(){return this._service}get parent(){const e=function(e){if(0===e.length)return null;const t=e.lastIndexOf("/");return-1===t?"":e.slice(0,t)}(this._location.path);if(null===e)return null;const t=new dc(this._location.bucket,e);return new $c(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw function(e){return new ic("invalid-root-operation","The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}(e)}}async function Kc(e){e._throwIfRoot("getDownloadURL");const t=function(e,t,n){const i=yc(t.fullServerUrl(),e.host),r=e.maxOperationRetryTime,s=new Wc(i,"GET",Bc(e,n),r);return s.errorHandler=Hc(t),s}(e.storage,e._location,Uc());return(await e.storage.makeRequestWithTokens(t)).getPromise().then((e=>{if(null===e)throw new ic("no-download-url","The given file does not have any download URLs.");return e}))}function Yc(e,t){if(e instanceof Xc){const n=e;if(null==n._bucket)throw new ic("no-default-bucket","No default bucket found. Did you set the 'storageBucket' property when initializing the app?");const i=new $c(n,n._bucket);return null!=t?Yc(i,t):i}return void 0!==t?function(e,t){const n=function(e,t){const n=t.split("/").filter((e=>e.length>0)).join("/");return 0===e.length?n:e+"/"+n}(e._location.path,t),i=new dc(e._location.bucket,n);return new $c(e.storage,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t):e}function Jc(e,t){if(t&&/^[A-Za-z]+:\/\//.test(t)){if(e instanceof Xc)return new $c(e,t);throw oc("To use ref(service, url), the first argument must be a Storage instance.")}return Yc(e,t)}function Qc(e,t){const n=null==t?void 0:t.storageBucket;return null==n?null:dc.makeFromBucketSpec(n,e)}class Xc{constructor(e,t,n,i,r,s){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._pool=i,this._url=r,this._firebaseVersion=s,this._bucket=null,this._host="firebasestorage.googleapis.com",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=r?dc.makeFromBucketSpec(r,this._host):Qc(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=dc.makeFromBucketSpec(this._url,e):this._bucket=Qc(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){mc("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){mc("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){return(await e.getToken()).token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((e=>e.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new $c(this,e)}_makeRequest(e,t,n){if(this._deleted)return new pc(ac());{const i=function(e,t,n,i,r,s){const o=vc(e.urlParams),a=e.url+o,l=Object.assign({},e.headers);return function(e,t){t&&(e["X-Firebase-GMPID"]=t)}(l,t),function(e,t){null!==t&&t.length>0&&(e.Authorization="Firebase "+t)}(l,n),function(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(null!=t?t:"AppManager")}(l,s),function(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}(l,i),new wc(a,e.method,l,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Zc(e,t,n){return function(e,t,n){e._throwIfRoot("uploadBytes");const i=Gc(e.storage,e._location,Uc(),new Oc(t,!0),n);return e.storage.makeRequestWithTokens(i).then((e=>e.getPromise())).then((t=>({metadata:t,ref:e})))}(e=Ue(e),t,n)}function eh(e){return Kc(e=Ue(e))}function th(e,t){return Jc(e=Ue(e),t)}function nh(e=lt(),t){return rt(e=Ue(e),"storage").getImmediate({identifier:t})}function ih(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new Xc(n,i,r,new uc,t,"9.0.0")}it(new qe("storage",ih,"PUBLIC").setMultipleInstances(!0)),ct("@firebase/storage","0.8.0");const rh=Symbol("store-raw"),sh=Symbol("store-node"),oh=Symbol("store-name");function ah(t,n){let i=t[e];if(!i){Object.defineProperty(t,e,{value:i=new Proxy(t,dh)});const n=Object.keys(t),r=Object.getOwnPropertyDescriptors(t);for(let e=0,s=n.length;e<s;e++){const s=n[e];if(r[s].get){const e=r[s].get.bind(i);Object.defineProperty(t,s,{get:e})}}}return i}function lh(e){return null!=e&&"object"==typeof e&&(!e.__proto__||e.__proto__===Object.prototype||Array.isArray(e))}function ch(e,t=new Set){let n,i,r,s;if(n=null!=e&&e[rh])return n;if(!lh(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let n=0,s=e.length;n<s;n++)r=e[n],(i=ch(r,t))!==r&&(e[n]=i)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const n=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let a=0,l=n.length;a<l;a++)s=n[a],o[s].get||(r=e[s],(i=ch(r,t))!==r&&(e[s]=i))}return e}function hh(e){let t=e[sh];return t||Object.defineProperty(e,sh,{value:t={}}),t}function uh(){const[e,t]=p(void 0,{equals:!1,internal:!0});return e.$=t,e}const dh={get(t,n,i){if(n===rh)return t;if(n===e)return i;const r=t[n];if(n===sh||"__proto__"===n)return r;const s=lh(r);if(w()&&("function"!=typeof r||t.hasOwnProperty(n))){let e,i;s&&(e=hh(r))&&(i=e._||(e._=uh()),i()),e=hh(t),i=e[n]||(e[n]=uh()),i()}return s?ah(r):r},set:()=>!0,deleteProperty:()=>!0,ownKeys:function(e){if(w()){const t=hh(e);(t._||(t._=uh()))()}return Reflect.ownKeys(e)},getOwnPropertyDescriptor:function(t,n){const i=Reflect.getOwnPropertyDescriptor(t,n);return!i||i.get||n===e||n===sh||n===oh||(delete i.value,delete i.writable,i.get=()=>t[e][n]),i}};function ph(e,t,n){if(e[t]===n)return;const i=Array.isArray(e),r=e.length,s=void 0===n,o=i||s===t in e;s?delete e[t]:e[t]=n;let a,l=hh(e);(a=l[t])&&a.$(),i&&e.length!==r&&(a=l.length)&&a.$(a,void 0),o&&(a=l._)&&a.$(a,void 0)}function fh(e,t,n=[]){let i,r=e;if(t.length>1){i=t.shift();const s=typeof i,o=Array.isArray(e);if(Array.isArray(i)){for(let r=0;r<i.length;r++)fh(e,[i[r]].concat(t),[i[r]].concat(n));return}if(o&&"function"===s){for(let r=0;r<e.length;r++)i(e[r],r)&&fh(e,[r].concat(t),[r].concat(n));return}if(o&&"object"===s){const{from:r=0,to:s=e.length-1,by:o=1}=i;for(let i=r;i<=s;i+=o)fh(e,[i].concat(t),[i].concat(n));return}if(t.length>1)return void fh(e[i],t,[i].concat(n));r=e[i],n=[i].concat(n)}let s=t[0];"function"==typeof s&&(s=s(r,n),s===r)||void 0===i&&null==s||(s=ch(s),void 0===i||lh(r)&&lh(s)&&!Array.isArray(s)?function(e,t){const n=Object.keys(t);for(let i=0;i<n.length;i+=1){const r=n[i];ph(e,r,t[r])}}(r,s):ph(e,i,s))}function _h(e,t){const n=ch(e||{});return[ah(n),function(...e){m((()=>fh(n,e)))}]}function gh(e,t,n,i,r){const s=t[n];if(e===s)return;if(!lh(e)||!lh(s)||r&&e[r]!==s[r])return void(e!==s&&ph(t,n,e));if(Array.isArray(e)){if(e.length&&s.length&&(!i||r&&null!=e[0][r])){let t,n,o,a,l,c,h,u;for(o=0,a=Math.min(s.length,e.length);o<a&&(s[o]===e[o]||r&&s[o][r]===e[o][r]);o++)gh(e[o],s,o,i,r);const d=new Array(e.length),p=new Map;for(a=s.length-1,l=e.length-1;a>=o&&l>=o&&(s[a]===e[l]||r&&s[a][r]===e[l][r]);a--,l--)d[l]=s[a];if(o>l||o>a){for(n=o;n<=l;n++)ph(s,n,e[n]);for(;n<e.length;n++)ph(s,n,d[n]),gh(e[n],s,n,i,r);return void(s.length>e.length&&ph(s,"length",e.length))}for(h=new Array(l+1),n=l;n>=o;n--)c=e[n],u=r?c[r]:c,t=p.get(u),h[n]=void 0===t?-1:t,p.set(u,n);for(t=o;t<=a;t++)c=s[t],u=r?c[r]:c,n=p.get(u),void 0!==n&&-1!==n&&(d[n]=s[t],n=h[n],p.set(u,n));for(n=o;n<e.length;n++)n in d?(ph(s,n,d[n]),gh(e[n],s,n,i,r)):ph(s,n,e[n])}else for(let t=0,n=e.length;t<n;t++)gh(e[t],s,t,i,r);return void(s.length>e.length&&ph(s,"length",e.length))}const o=Object.keys(e);for(let l=0,c=o.length;l<c;l++)gh(e[o[l]],s,o[l],i,r);const a=Object.keys(s);for(let l=0,c=a.length;l<c;l++)void 0===e[a[l]]&&ph(s,a[l],void 0)}function mh(e,t={}){const{merge:n,key:i="id"}=t,r=ch(e);return e=>{const t=e;return lh(t)&&lh(r)?(gh(r,{state:t},"state",n,i),t):r}}function yh(e,t){return[e[0]+t[0],e[1]+t[1]]}function vh(e,t){return[e[0]-t[0],e[1]-t[1]]}function wh(e,t){return[t[0]-e[0],t[1]-e[1]]}function bh(e,t){return[e[0]*t,e[1]*t]}function Ch(e){return[e[1],-e[0]]}function Ih(e,t){return e[0]*t[0]+e[1]*t[1]}function kh(e,t){return function(e){return e[0]*e[0]+e[1]*e[1]}(vh(e,t))}function Eh(e){return function(e,t){return[e[0]/t,e[1]/t]}(e,function(e){return Math.hypot(e[0],e[1])}(e))}function Th(e,t){return Math.hypot(e[1]-t[1],e[0]-t[0])}function Sh(e,t,n){let i=Math.sin(n),r=Math.cos(n),s=e[0]-t[0],o=e[1]-t[1],a=s*i+o*r;return[s*r-o*i+t[0],a+t[1]]}function xh(e,t,n){return yh(e,bh(wh(e,t),n))}function Rh(e,t){return e[0]===t[0]&&e[1]===t[1]}function Ph(e,t,n){return e*(1-n)+t*n}function Nh(e,t,n){return Math.max(t,Math.min(n,e))}function Oh(e,t,n,i=.5){return t?(i=Nh(n(i),0,1),(t<0?Ph(e,e+e*Nh(t,-.95,-.05),i):Ph(e-e*Nh(t,.05,.95),e,i))/2):e/2}var{min:Ah,PI:Dh}=Math;function Mh(e,t={}){let{streamline:n=.5}=t,{simulatePressure:i=!0}=t;n/=i?4:2;let r=function(e){return Array.isArray(e[0])?e.map((([e,t,n=.5])=>[e,t,n])):e.map((({x:e,y:t,pressure:n=.5})=>[e,t,n]))}(e);if(0===r.length)return[];1===r.length&&r.push([...yh(r[0],[1,1]),r[0][2]]);let s=[{point:[r[0][0],r[0][1]],pressure:r[0][2],vector:[0,0],distance:0,runningLength:0}];for(let o=1,a=0,l=r[o],c=s[a];o<r.length;o++,l=r[o],c=s[a]){let e=xh(c.point,l,1-n);if(Rh(c.point,e))continue;let t=Eh(vh(c.point,e)),i=Th(e,c.point),r=c.runningLength+i,o={point:e,pressure:l[2],vector:t,distance:i,runningLength:r};s.push(o),a+=1}return s}function Lh(e,t={}){let{size:n=8,thinning:i=.5,smoothing:r=.5,simulatePressure:s=!0,easing:o=(e=>e),start:a={},end:l={},last:c=!1}=t,{streamline:h=.5}=t;h/=2;let{cap:u=!0,taper:d=0,easing:p=(e=>e*(2-e))}=a,{cap:f=!0,taper:_=0,easing:g=(e=>--e*e*e+1)}=l,m=e.length;if(0===m)return[];let y=e[m-1].runningLength,v=[],w=[],b=e.slice(0,5).reduce(((e,t)=>(e+t.pressure)/2),e[0].pressure),C=Oh(n,i,o,e[m-1].pressure),I=e[0].vector,k=e[0].point,E=k,T=k,S=E,x=!0;for(let D=0;D<m-1;D++){let{pressure:t}=e[D],{point:a,vector:l,distance:c,runningLength:u}=e[D];if(D>0&&x&&u<n/2)continue;if(x&&(x=!1),i){if(s){let e=Ah(1,1-c/n),i=Ah(1,c/n);t=Ah(1,b+i/2*(e-b))}C=Oh(n,i,o,t)}else C=n/2;let f=u<d?p(u/d):1,m=y-u<_?g((y-u)/_):1;C=Math.max(.01,C*Math.min(f,m));let R=e[D+1].vector,P=Ih(l,R);if(P<0){let e=bh(Ch(I),C);for(let t=0;t<1;t+=.2)S=Sh(yh(a,e),a,Dh*-t),T=Sh(vh(a,e),a,Dh*t),w.push(S),v.push(T);k=T,E=S;continue}let N=bh(Ch(xh(R,l,P)),C);T=vh(a,N),S=yh(a,N);let O=D<2||P<.25,A=Math.pow(Math.max((u>n?n:n/2)*r,1),2);(O||kh(k,T)>A)&&(v.push(xh(k,T,h)),k=T),(O||kh(E,S)>A)&&(w.push(xh(E,S,h)),E=S),b=t,I=l}let R=e[0],P=e[m-1],N=x||w.length<2||v.length<2;if(N&&(!d&&!_||c)){let t=0;for(let a=0;a<m;a++){let{pressure:r,runningLength:s}=e[a];if(s>n){t=Oh(n,i,o,r);break}}let r=vh(R.point,bh(Ch(Eh(wh(P.point,R.point))),t||C)),s=[];for(let e=0,n=.1;e<=1;e+=n)s.push(Sh(r,R.point,2*Dh*e));return s}let O=[],A=[];if(v.length>1&&w.length>1){S=w[1];for(let t=1;t<v.length;t++)if(!Rh(S,v[t])){T=v[t];break}if(u||d){if(d||_&&N)O.push(R.point,yh(R.point,[.1,.1]));else if(!Rh(S,T)){let e=vh(R.point,bh(Eh(wh(S,T)),Th(S,T)/2));for(let t=0,n=.1;t<=1;t+=n)O.push(Sh(e,R.point,Dh*t));v.shift(),w.shift()}}else if(!Rh(S,T)){let e=Eh(wh(S,T)),t=Th(S,T)/2;O.push(vh(R.point,bh(e,.95*t))),O.push(vh(R.point,bh(e,t))),O.push(yh(R.point,bh(e,t))),O.push(yh(R.point,bh(e,.95*t))),v.shift(),w.shift()}let e=function(e,t){return bh(yh(e,t),.5)}(v[v.length-1],w[w.length-1]),n=t.last?P.point:xh(e,P.point,.618),i=Eh(vh(n,e));if(f||_)if(_||d&&N)A.push(n);else{let e=yh(n,bh(Ch(i),C));for(let t=0,i=.15;t<=1;t+=i)A.push(Sh(e,n,3*Dh*t))}else{let t=xh(e,n,.95),r=.95*C;A.push(yh(t,bh(Ch(i),r))),A.push(yh(n,bh(Ch(i),r))),A.push(vh(n,bh(Ch(i),r))),A.push(vh(t,bh(Ch(i),r)))}}return v.concat(A,w.reverse(),O)}function Fh(e,t={}){return Lh(Mh(e,t),t)}
/**
 * splaytree v3.1.0
 ...
 * @license MIT
 * @preserve
 */var Uh=function(e,t){this.next=null,this.key=e,this.data=t,this.left=null,this.right=null};function qh(e,t){return e>t?1:e<t?-1:0}function jh(e,t,n){for(var i=new Uh(null,null),r=i,s=i;;){var o=n(e,t.key);if(o<0){if(null===t.left)break;if(n(e,t.left.key)<0){var a=t.left;if(t.left=a.right,a.right=t,null===(t=a).left)break}s.left=t,s=t,t=t.left}else{if(!(o>0))break;if(null===t.right)break;if(n(e,t.right.key)>0){a=t.right;if(t.right=a.left,a.left=t,null===(t=a).right)break}r.right=t,r=t,t=t.right}}return r.right=t.left,s.left=t.right,t.left=i.right,t.right=i.left,t}function Wh(e,t,n,i){var r=new Uh(e,t);if(null===n)return r.left=r.right=null,r;var s=i(e,(n=jh(e,n,i)).key);return s<0?(r.left=n.left,r.right=n,n.left=null):s>=0&&(r.right=n.right,r.left=n,n.right=null),r}function zh(e,t,n){var i=null,r=null;if(t){var s=n((t=jh(e,t,n)).key,e);0===s?(i=t.left,r=t.right):s<0?(r=t.right,t.right=null,i=t):(i=t.left,t.left=null,r=t)}return{left:i,right:r}}function Bh(e,t,n,i,r){if(e){i(t+(n?"└── ":"├── ")+r(e)+"\n");var s=t+(n?"    ":"│   ");e.left&&Bh(e.left,s,!1,i,r),e.right&&Bh(e.right,s,!0,i,r)}}var Vh=function(){function e(e){void 0===e&&(e=qh),this._root=null,this._size=0,this._comparator=e}return e.prototype.insert=function(e,t){return this._size++,this._root=Wh(e,t,this._root,this._comparator)},e.prototype.add=function(e,t){var n=new Uh(e,t);null===this._root&&(n.left=n.right=null,this._size++,this._root=n);var i=this._comparator,r=jh(e,this._root,i),s=i(e,r.key);return 0===s?this._root=r:(s<0?(n.left=r.left,n.right=r,r.left=null):s>0&&(n.right=r.right,n.left=r,r.right=null),this._size++,this._root=n),this._root},e.prototype.remove=function(e){this._root=this._remove(e,this._root,this._comparator)},e.prototype._remove=function(e,t,n){var i;return null===t?null:0===n(e,(t=jh(e,t,n)).key)?(null===t.left?i=t.right:(i=jh(e,t.left,n)).right=t.right,this._size--,i):t},e.prototype.pop=function(){var e=this._root;if(e){for(;e.left;)e=e.left;return this._root=jh(e.key,this._root,this._comparator),this._root=this._remove(e.key,this._root,this._comparator),{key:e.key,data:e.data}}return null},e.prototype.findStatic=function(e){for(var t=this._root,n=this._comparator;t;){var i=n(e,t.key);if(0===i)return t;t=i<0?t.left:t.right}return null},e.prototype.find=function(e){return this._root&&(this._root=jh(e,this._root,this._comparator),0!==this._comparator(e,this._root.key))?null:this._root},e.prototype.contains=function(e){for(var t=this._root,n=this._comparator;t;){var i=n(e,t.key);if(0===i)return!0;t=i<0?t.left:t.right}return!1},e.prototype.forEach=function(e,t){for(var n=this._root,i=[],r=!1;!r;)null!==n?(i.push(n),n=n.left):0!==i.length?(n=i.pop(),e.call(t,n),n=n.right):r=!0;return this},e.prototype.range=function(e,t,n,i){for(var r=[],s=this._comparator,o=this._root;0!==r.length||o;)if(o)r.push(o),o=o.left;else{if(s((o=r.pop()).key,t)>0)break;if(s(o.key,e)>=0&&n.call(i,o))return this;o=o.right}return this},e.prototype.keys=function(){var e=[];return this.forEach((function(t){var n=t.key;return e.push(n)})),e},e.prototype.values=function(){var e=[];return this.forEach((function(t){var n=t.data;return e.push(n)})),e},e.prototype.min=function(){return this._root?this.minNode(this._root).key:null},e.prototype.max=function(){return this._root?this.maxNode(this._root).key:null},e.prototype.minNode=function(e){if(void 0===e&&(e=this._root),e)for(;e.left;)e=e.left;return e},e.prototype.maxNode=function(e){if(void 0===e&&(e=this._root),e)for(;e.right;)e=e.right;return e},e.prototype.at=function(e){for(var t=this._root,n=!1,i=0,r=[];!n;)if(t)r.push(t),t=t.left;else if(r.length>0){if(t=r.pop(),i===e)return t;i++,t=t.right}else n=!0;return null},e.prototype.next=function(e){var t=this._root,n=null;if(e.right){for(n=e.right;n.left;)n=n.left;return n}for(var i=this._comparator;t;){var r=i(e.key,t.key);if(0===r)break;r<0?(n=t,t=t.left):t=t.right}return n},e.prototype.prev=function(e){var t=this._root,n=null;if(null!==e.left){for(n=e.left;n.right;)n=n.right;return n}for(var i=this._comparator;t;){var r=i(e.key,t.key);if(0===r)break;r<0?t=t.left:(n=t,t=t.right)}return n},e.prototype.clear=function(){return this._root=null,this._size=0,this},e.prototype.toList=function(){return function(e){var t=e,n=[],i=!1,r=new Uh(null,null),s=r;for(;!i;)t?(n.push(t),t=t.left):n.length>0?t=(t=s=s.next=n.pop()).right:i=!0;return s.next=null,r.next}(this._root)},e.prototype.load=function(e,t,n){void 0===t&&(t=[]),void 0===n&&(n=!1);var i=e.length,r=this._comparator;if(n&&$h(e,t,0,i-1,r),null===this._root)this._root=Hh(e,t,0,i),this._size=i;else{var s=function(e,t,n){var i=new Uh(null,null),r=i,s=e,o=t;for(;null!==s&&null!==o;)n(s.key,o.key)<0?(r.next=s,s=s.next):(r.next=o,o=o.next),r=r.next;null!==s?r.next=s:null!==o&&(r.next=o);return i.next}(this.toList(),function(e,t){for(var n=new Uh(null,null),i=n,r=0;r<e.length;r++)i=i.next=new Uh(e[r],t[r]);return i.next=null,n.next}(e,t),r);i=this._size+i,this._root=Gh({head:s},0,i)}return this},e.prototype.isEmpty=function(){return null===this._root},Object.defineProperty(e.prototype,"size",{get:function(){return this._size},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"root",{get:function(){return this._root},enumerable:!0,configurable:!0}),e.prototype.toString=function(e){void 0===e&&(e=function(e){return String(e.key)});var t=[];return Bh(this._root,"",!0,(function(e){return t.push(e)}),e),t.join("")},e.prototype.update=function(e,t,n){var i=this._comparator,r=zh(e,this._root,i),s=r.left,o=r.right;i(e,t)<0?o=Wh(t,n,o,i):s=Wh(t,n,s,i),this._root=function(e,t,n){return null===t?e:(null===e||((t=jh(e.key,t,n)).left=e),t)}(s,o,i)},e.prototype.split=function(e){return zh(e,this._root,this._comparator)},e}();function Hh(e,t,n,i){var r=i-n;if(r>0){var s=n+Math.floor(r/2),o=e[s],a=t[s],l=new Uh(o,a);return l.left=Hh(e,t,n,s),l.right=Hh(e,t,s+1,i),l}return null}function Gh(e,t,n){var i=n-t;if(i>0){var r=t+Math.floor(i/2),s=Gh(e,t,r),o=e.head;return o.left=s,e.head=e.head.next,o.right=Gh(e,r+1,n),o}return null}function $h(e,t,n,i,r){if(!(n>=i)){for(var s=e[n+i>>1],o=n-1,a=i+1;;){do{o++}while(r(e[o],s)<0);do{a--}while(r(e[a],s)>0);if(o>=a)break;var l=e[o];e[o]=e[a],e[a]=l,l=t[o],t[o]=t[a],t[a]=l}$h(e,t,n,a,r),$h(e,t,a+1,i,r)}}function Kh(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Yh(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function Jh(e,t,n){return t&&Yh(e.prototype,t),n&&Yh(e,n),e}var Qh=function(e,t){return e.ll.x<=t.x&&t.x<=e.ur.x&&e.ll.y<=t.y&&t.y<=e.ur.y},Xh=function(e,t){if(t.ur.x<e.ll.x||e.ur.x<t.ll.x||t.ur.y<e.ll.y||e.ur.y<t.ll.y)return null;var n=e.ll.x<t.ll.x?t.ll.x:e.ll.x,i=e.ur.x<t.ur.x?e.ur.x:t.ur.x;return{ll:{x:n,y:e.ll.y<t.ll.y?t.ll.y:e.ll.y},ur:{x:i,y:e.ur.y<t.ur.y?e.ur.y:t.ur.y}}},Zh=Number.EPSILON;void 0===Zh&&(Zh=Math.pow(2,-52));var eu=Zh*Zh,tu=function(e,t){if(-Zh<e&&e<Zh&&-Zh<t&&t<Zh)return 0;var n=e-t;return n*n<eu*e*t?0:e<t?-1:1},nu=function(){function e(){Kh(this,e),this.reset()}return Jh(e,[{key:"reset",value:function(){this.xRounder=new iu,this.yRounder=new iu}},{key:"round",value:function(e,t){return{x:this.xRounder.round(e),y:this.yRounder.round(t)}}}]),e}(),iu=function(){function e(){Kh(this,e),this.tree=new Vh,this.round(0)}return Jh(e,[{key:"round",value:function(e){var t=this.tree.add(e),n=this.tree.prev(t);if(null!==n&&0===tu(t.key,n.key))return this.tree.remove(e),n.key;var i=this.tree.next(t);return null!==i&&0===tu(t.key,i.key)?(this.tree.remove(e),i.key):e}}]),e}(),ru=new nu,su=function(e,t){return e.x*t.y-e.y*t.x},ou=function(e,t){return e.x*t.x+e.y*t.y},au=function(e,t,n){var i={x:t.x-e.x,y:t.y-e.y},r={x:n.x-e.x,y:n.y-e.y},s=su(i,r);return tu(s,0)},lu=function(e){return Math.sqrt(ou(e,e))},cu=function(e,t,n){var i={x:t.x-e.x,y:t.y-e.y},r={x:n.x-e.x,y:n.y-e.y};return ou(r,i)/lu(r)/lu(i)},hu=function(e,t,n){return 0===t.y?null:{x:e.x+t.x/t.y*(n-e.y),y:n}},uu=function(e,t,n){return 0===t.x?null:{x:n,y:e.y+t.y/t.x*(n-e.x)}},du=function(){function e(t,n){Kh(this,e),void 0===t.events?t.events=[this]:t.events.push(this),this.point=t,this.isLeft=n}return Jh(e,null,[{key:"compare",value:function(t,n){var i=e.comparePoints(t.point,n.point);return 0!==i?i:(t.point!==n.point&&t.link(n),t.isLeft!==n.isLeft?t.isLeft?1:-1:fu.compare(t.segment,n.segment))}},{key:"comparePoints",value:function(e,t){return e.x<t.x?-1:e.x>t.x?1:e.y<t.y?-1:e.y>t.y?1:0}}]),Jh(e,[{key:"link",value:function(e){if(e.point===this.point)throw new Error("Tried to link already linked events");for(var t=e.point.events,n=0,i=t.length;n<i;n++){var r=t[n];this.point.events.push(r),r.point=this.point}this.checkForConsuming()}},{key:"checkForConsuming",value:function(){for(var e=this.point.events.length,t=0;t<e;t++){var n=this.point.events[t];if(void 0===n.segment.consumedBy)for(var i=t+1;i<e;i++){var r=this.point.events[i];void 0===r.consumedBy&&(n.otherSE.point.events===r.otherSE.point.events&&n.segment.consume(r.segment))}}}},{key:"getAvailableLinkedEvents",value:function(){for(var e=[],t=0,n=this.point.events.length;t<n;t++){var i=this.point.events[t];i!==this&&!i.segment.ringOut&&i.segment.isInResult()&&e.push(i)}return e}},{key:"getLeftmostComparator",value:function(e){var t=this,n=new Map,i=function(i){var r,s,o,a,l,c=i.otherSE;n.set(i,{sine:(r=t.point,s=e.point,o=c.point,a={x:s.x-r.x,y:s.y-r.y},l={x:o.x-r.x,y:o.y-r.y},su(l,a)/lu(l)/lu(a)),cosine:cu(t.point,e.point,c.point)})};return function(e,t){n.has(e)||i(e),n.has(t)||i(t);var r=n.get(e),s=r.sine,o=r.cosine,a=n.get(t),l=a.sine,c=a.cosine;return s>=0&&l>=0?o<c?1:o>c?-1:0:s<0&&l<0?o<c?-1:o>c?1:0:l<s?-1:l>s?1:0}}}]),e}(),pu=0,fu=function(){function e(t,n,i,r){Kh(this,e),this.id=++pu,this.leftSE=t,t.segment=this,t.otherSE=n,this.rightSE=n,n.segment=this,n.otherSE=t,this.rings=i,this.windings=r}return Jh(e,null,[{key:"compare",value:function(e,t){var n=e.leftSE.point.x,i=t.leftSE.point.x,r=e.rightSE.point.x,s=t.rightSE.point.x;if(s<n)return 1;if(r<i)return-1;var o=e.leftSE.point.y,a=t.leftSE.point.y,l=e.rightSE.point.y,c=t.rightSE.point.y;if(n<i){if(a<o&&a<l)return 1;if(a>o&&a>l)return-1;var h=e.comparePoint(t.leftSE.point);if(h<0)return 1;if(h>0)return-1;var u=t.comparePoint(e.rightSE.point);return 0!==u?u:-1}if(n>i){if(o<a&&o<c)return-1;if(o>a&&o>c)return 1;var d=t.comparePoint(e.leftSE.point);if(0!==d)return d;var p=e.comparePoint(t.rightSE.point);return p<0?1:p>0?-1:1}if(o<a)return-1;if(o>a)return 1;if(r<s){var f=t.comparePoint(e.rightSE.point);if(0!==f)return f}if(r>s){var _=e.comparePoint(t.rightSE.point);if(_<0)return 1;if(_>0)return-1}if(r!==s){var g=l-o,m=r-n,y=c-a,v=s-i;if(g>m&&y<v)return 1;if(g<m&&y>v)return-1}return r>s?1:r<s||l<c?-1:l>c?1:e.id<t.id?-1:e.id>t.id?1:0}}]),Jh(e,[{key:"replaceRightSE",value:function(e){this.rightSE=e,this.rightSE.segment=this,this.rightSE.otherSE=this.leftSE,this.leftSE.otherSE=this.rightSE}},{key:"bbox",value:function(){var e=this.leftSE.point.y,t=this.rightSE.point.y;return{ll:{x:this.leftSE.point.x,y:e<t?e:t},ur:{x:this.rightSE.point.x,y:e>t?e:t}}}},{key:"vector",value:function(){return{x:this.rightSE.point.x-this.leftSE.point.x,y:this.rightSE.point.y-this.leftSE.point.y}}},{key:"isAnEndpoint",value:function(e){return e.x===this.leftSE.point.x&&e.y===this.leftSE.point.y||e.x===this.rightSE.point.x&&e.y===this.rightSE.point.y}},{key:"comparePoint",value:function(e){if(this.isAnEndpoint(e))return 0;var t=this.leftSE.point,n=this.rightSE.point,i=this.vector();if(t.x===n.x)return e.x===t.x?0:e.x<t.x?1:-1;var r=(e.y-t.y)/i.y,s=t.x+r*i.x;if(e.x===s)return 0;var o=(e.x-t.x)/i.x,a=t.y+o*i.y;return e.y===a?0:e.y<a?-1:1}},{key:"getIntersection",value:function(e){var t=this.bbox(),n=e.bbox(),i=Xh(t,n);if(null===i)return null;var r=this.leftSE.point,s=this.rightSE.point,o=e.leftSE.point,a=e.rightSE.point,l=Qh(t,o)&&0===this.comparePoint(o),c=Qh(n,r)&&0===e.comparePoint(r),h=Qh(t,a)&&0===this.comparePoint(a),u=Qh(n,s)&&0===e.comparePoint(s);if(c&&l)return u&&!h?s:!u&&h?a:null;if(c)return h&&r.x===a.x&&r.y===a.y?null:r;if(l)return u&&s.x===o.x&&s.y===o.y?null:o;if(u&&h)return null;if(u)return s;if(h)return a;var d=function(e,t,n,i){if(0===t.x)return uu(n,i,e.x);if(0===i.x)return uu(e,t,n.x);if(0===t.y)return hu(n,i,e.y);if(0===i.y)return hu(e,t,n.y);var r=su(t,i);if(0==r)return null;var s={x:n.x-e.x,y:n.y-e.y},o=su(s,t)/r,a=su(s,i)/r;return{x:(e.x+a*t.x+(n.x+o*i.x))/2,y:(e.y+a*t.y+(n.y+o*i.y))/2}}(r,this.vector(),o,e.vector());return null===d?null:Qh(i,d)?ru.round(d.x,d.y):null}},{key:"split",value:function(t){var n=[],i=void 0!==t.events,r=new du(t,!0),s=new du(t,!1),o=this.rightSE;this.replaceRightSE(s),n.push(s),n.push(r);var a=new e(r,o,this.rings.slice(),this.windings.slice());return du.comparePoints(a.leftSE.point,a.rightSE.point)>0&&a.swapEvents(),du.comparePoints(this.leftSE.point,this.rightSE.point)>0&&this.swapEvents(),i&&(r.checkForConsuming(),s.checkForConsuming()),n}},{key:"swapEvents",value:function(){var e=this.rightSE;this.rightSE=this.leftSE,this.leftSE=e,this.leftSE.isLeft=!0,this.rightSE.isLeft=!1;for(var t=0,n=this.windings.length;t<n;t++)this.windings[t]*=-1}},{key:"consume",value:function(t){for(var n=this,i=t;n.consumedBy;)n=n.consumedBy;for(;i.consumedBy;)i=i.consumedBy;var r=e.compare(n,i);if(0!==r){if(r>0){var s=n;n=i,i=s}if(n.prev===i){var o=n;n=i,i=o}for(var a=0,l=i.rings.length;a<l;a++){var c=i.rings[a],h=i.windings[a],u=n.rings.indexOf(c);-1===u?(n.rings.push(c),n.windings.push(h)):n.windings[u]+=h}i.rings=null,i.windings=null,i.consumedBy=n,i.leftSE.consumedBy=n.leftSE,i.rightSE.consumedBy=n.rightSE}}},{key:"prevInResult",value:function(){return void 0!==this._prevInResult||(this.prev?this.prev.isInResult()?this._prevInResult=this.prev:this._prevInResult=this.prev.prevInResult():this._prevInResult=null),this._prevInResult}},{key:"beforeState",value:function(){if(void 0!==this._beforeState)return this._beforeState;if(this.prev){var e=this.prev.consumedBy||this.prev;this._beforeState=e.afterState()}else this._beforeState={rings:[],windings:[],multiPolys:[]};return this._beforeState}},{key:"afterState",value:function(){if(void 0!==this._afterState)return this._afterState;var e=this.beforeState();this._afterState={rings:e.rings.slice(0),windings:e.windings.slice(0),multiPolys:[]};for(var t=this._afterState.rings,n=this._afterState.windings,i=this._afterState.multiPolys,r=0,s=this.rings.length;r<s;r++){var o=this.rings[r],a=this.windings[r],l=t.indexOf(o);-1===l?(t.push(o),n.push(a)):n[l]+=a}for(var c=[],h=[],u=0,d=t.length;u<d;u++)if(0!==n[u]){var p=t[u],f=p.poly;if(-1===h.indexOf(f))if(p.isExterior)c.push(f);else{-1===h.indexOf(f)&&h.push(f);var _=c.indexOf(p.poly);-1!==_&&c.splice(_,1)}}for(var g=0,m=c.length;g<m;g++){var y=c[g].multiPoly;-1===i.indexOf(y)&&i.push(y)}return this._afterState}},{key:"isInResult",value:function(){if(this.consumedBy)return!1;if(void 0!==this._isInResult)return this._isInResult;var e=this.beforeState().multiPolys,t=this.afterState().multiPolys;switch(ku.type){case"union":var n=0===e.length,i=0===t.length;this._isInResult=n!==i;break;case"intersection":var r,s;e.length<t.length?(r=e.length,s=t.length):(r=t.length,s=e.length),this._isInResult=s===ku.numMultiPolys&&r<s;break;case"xor":var o=Math.abs(e.length-t.length);this._isInResult=o%2==1;break;case"difference":var a=function(e){return 1===e.length&&e[0].isSubject};this._isInResult=a(e)!==a(t);break;default:throw new Error("Unrecognized operation type found ".concat(ku.type))}return this._isInResult}}],[{key:"fromRing",value:function(t,n,i){var r,s,o,a=du.comparePoints(t,n);if(a<0)r=t,s=n,o=1;else{if(!(a>0))throw new Error("Tried to create degenerate segment at [".concat(t.x,", ").concat(t.y,"]"));r=n,s=t,o=-1}return new e(new du(r,!0),new du(s,!1),[i],[o])}}]),e}(),_u=function(){function e(t,n,i){if(Kh(this,e),!Array.isArray(t)||0===t.length)throw new Error("Input geometry is not a valid Polygon or MultiPolygon");if(this.poly=n,this.isExterior=i,this.segments=[],"number"!=typeof t[0][0]||"number"!=typeof t[0][1])throw new Error("Input geometry is not a valid Polygon or MultiPolygon");var r=ru.round(t[0][0],t[0][1]);this.bbox={ll:{x:r.x,y:r.y},ur:{x:r.x,y:r.y}};for(var s=r,o=1,a=t.length;o<a;o++){if("number"!=typeof t[o][0]||"number"!=typeof t[o][1])throw new Error("Input geometry is not a valid Polygon or MultiPolygon");var l=ru.round(t[o][0],t[o][1]);l.x===s.x&&l.y===s.y||(this.segments.push(fu.fromRing(s,l,this)),l.x<this.bbox.ll.x&&(this.bbox.ll.x=l.x),l.y<this.bbox.ll.y&&(this.bbox.ll.y=l.y),l.x>this.bbox.ur.x&&(this.bbox.ur.x=l.x),l.y>this.bbox.ur.y&&(this.bbox.ur.y=l.y),s=l)}r.x===s.x&&r.y===s.y||this.segments.push(fu.fromRing(s,r,this))}return Jh(e,[{key:"getSweepEvents",value:function(){for(var e=[],t=0,n=this.segments.length;t<n;t++){var i=this.segments[t];e.push(i.leftSE),e.push(i.rightSE)}return e}}]),e}(),gu=function(){function e(t,n){if(Kh(this,e),!Array.isArray(t))throw new Error("Input geometry is not a valid Polygon or MultiPolygon");this.exteriorRing=new _u(t[0],this,!0),this.bbox={ll:{x:this.exteriorRing.bbox.ll.x,y:this.exteriorRing.bbox.ll.y},ur:{x:this.exteriorRing.bbox.ur.x,y:this.exteriorRing.bbox.ur.y}},this.interiorRings=[];for(var i=1,r=t.length;i<r;i++){var s=new _u(t[i],this,!1);s.bbox.ll.x<this.bbox.ll.x&&(this.bbox.ll.x=s.bbox.ll.x),s.bbox.ll.y<this.bbox.ll.y&&(this.bbox.ll.y=s.bbox.ll.y),s.bbox.ur.x>this.bbox.ur.x&&(this.bbox.ur.x=s.bbox.ur.x),s.bbox.ur.y>this.bbox.ur.y&&(this.bbox.ur.y=s.bbox.ur.y),this.interiorRings.push(s)}this.multiPoly=n}return Jh(e,[{key:"getSweepEvents",value:function(){for(var e=this.exteriorRing.getSweepEvents(),t=0,n=this.interiorRings.length;t<n;t++)for(var i=this.interiorRings[t].getSweepEvents(),r=0,s=i.length;r<s;r++)e.push(i[r]);return e}}]),e}(),mu=function(){function e(t,n){if(Kh(this,e),!Array.isArray(t))throw new Error("Input geometry is not a valid Polygon or MultiPolygon");try{"number"==typeof t[0][0][0]&&(t=[t])}catch(o){}this.polys=[],this.bbox={ll:{x:Number.POSITIVE_INFINITY,y:Number.POSITIVE_INFINITY},ur:{x:Number.NEGATIVE_INFINITY,y:Number.NEGATIVE_INFINITY}};for(var i=0,r=t.length;i<r;i++){var s=new gu(t[i],this);s.bbox.ll.x<this.bbox.ll.x&&(this.bbox.ll.x=s.bbox.ll.x),s.bbox.ll.y<this.bbox.ll.y&&(this.bbox.ll.y=s.bbox.ll.y),s.bbox.ur.x>this.bbox.ur.x&&(this.bbox.ur.x=s.bbox.ur.x),s.bbox.ur.y>this.bbox.ur.y&&(this.bbox.ur.y=s.bbox.ur.y),this.polys.push(s)}this.isSubject=n}return Jh(e,[{key:"getSweepEvents",value:function(){for(var e=[],t=0,n=this.polys.length;t<n;t++)for(var i=this.polys[t].getSweepEvents(),r=0,s=i.length;r<s;r++)e.push(i[r]);return e}}]),e}(),yu=function(){function e(t){Kh(this,e),this.events=t;for(var n=0,i=t.length;n<i;n++)t[n].segment.ringOut=this;this.poly=null}return Jh(e,null,[{key:"factory",value:function(t){for(var n=[],i=0,r=t.length;i<r;i++){var s=t[i];if(s.isInResult()&&!s.ringOut){for(var o=null,a=s.leftSE,l=s.rightSE,c=[a],h=a.point,u=[];o=a,a=l,c.push(a),a.point!==h;)for(;;){var d=a.getAvailableLinkedEvents();if(0===d.length){var p=c[0].point,f=c[c.length-1].point;throw new Error("Unable to complete output ring starting at [".concat(p.x,",")+" ".concat(p.y,"]. Last matching segment found ends at")+" [".concat(f.x,", ").concat(f.y,"]."))}if(1===d.length){l=d[0].otherSE;break}for(var _=null,g=0,m=u.length;g<m;g++)if(u[g].point===a.point){_=g;break}if(null===_){u.push({index:c.length,point:a.point});var y=a.getLeftmostComparator(o);l=d.sort(y)[0].otherSE;break}var v=u.splice(_)[0],w=c.splice(v.index);w.unshift(w[0].otherSE),n.push(new e(w.reverse()))}n.push(new e(c))}}return n}}]),Jh(e,[{key:"getGeom",value:function(){for(var e=this.events[0].point,t=[e],n=1,i=this.events.length-1;n<i;n++){var r=this.events[n].point,s=this.events[n+1].point;0!==au(r,e,s)&&(t.push(r),e=r)}if(1===t.length)return null;var o=t[0],a=t[1];0===au(o,e,a)&&t.shift(),t.push(t[0]);for(var l=this.isExteriorRing()?1:-1,c=this.isExteriorRing()?0:t.length-1,h=this.isExteriorRing()?t.length:-1,u=[],d=c;d!=h;d+=l)u.push([t[d].x,t[d].y]);return u}},{key:"isExteriorRing",value:function(){if(void 0===this._isExteriorRing){var e=this.enclosingRing();this._isExteriorRing=!e||!e.isExteriorRing()}return this._isExteriorRing}},{key:"enclosingRing",value:function(){return void 0===this._enclosingRing&&(this._enclosingRing=this._calcEnclosingRing()),this._enclosingRing}},{key:"_calcEnclosingRing",value:function(){for(var e=this.events[0],t=1,n=this.events.length;t<n;t++){var i=this.events[t];du.compare(e,i)>0&&(e=i)}for(var r=e.segment.prevInResult(),s=r?r.prevInResult():null;;){if(!r)return null;if(!s)return r.ringOut;if(s.ringOut!==r.ringOut)return s.ringOut.enclosingRing()!==r.ringOut?r.ringOut:r.ringOut.enclosingRing();r=s.prevInResult(),s=r?r.prevInResult():null}}}]),e}(),vu=function(){function e(t){Kh(this,e),this.exteriorRing=t,t.poly=this,this.interiorRings=[]}return Jh(e,[{key:"addInterior",value:function(e){this.interiorRings.push(e),e.poly=this}},{key:"getGeom",value:function(){var e=[this.exteriorRing.getGeom()];if(null===e[0])return null;for(var t=0,n=this.interiorRings.length;t<n;t++){var i=this.interiorRings[t].getGeom();null!==i&&e.push(i)}return e}}]),e}(),wu=function(){function e(t){Kh(this,e),this.rings=t,this.polys=this._composePolys(t)}return Jh(e,[{key:"getGeom",value:function(){for(var e=[],t=0,n=this.polys.length;t<n;t++){var i=this.polys[t].getGeom();null!==i&&e.push(i)}return e}},{key:"_composePolys",value:function(e){for(var t=[],n=0,i=e.length;n<i;n++){var r=e[n];if(!r.poly)if(r.isExteriorRing())t.push(new vu(r));else{var s=r.enclosingRing();s.poly||t.push(new vu(s)),s.poly.addInterior(r)}}return t}}]),e}(),bu=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:fu.compare;Kh(this,e),this.queue=t,this.tree=new Vh(n),this.segments=[]}return Jh(e,[{key:"process",value:function(e){var t=e.segment,n=[];if(e.consumedBy)return e.isLeft?this.queue.remove(e.otherSE):this.tree.remove(t),n;var i=e.isLeft?this.tree.insert(t):this.tree.find(t);if(!i)throw new Error("Unable to find segment #".concat(t.id," ")+"[".concat(t.leftSE.point.x,", ").concat(t.leftSE.point.y,"] -> ")+"[".concat(t.rightSE.point.x,", ").concat(t.rightSE.point.y,"] ")+"in SweepLine tree. Please submit a bug report.");for(var r=i,s=i,o=void 0,a=void 0;void 0===o;)null===(r=this.tree.prev(r))?o=null:void 0===r.key.consumedBy&&(o=r.key);for(;void 0===a;)null===(s=this.tree.next(s))?a=null:void 0===s.key.consumedBy&&(a=s.key);if(e.isLeft){var l=null;if(o){var c=o.getIntersection(t);if(null!==c&&(t.isAnEndpoint(c)||(l=c),!o.isAnEndpoint(c)))for(var h=this._splitSafely(o,c),u=0,d=h.length;u<d;u++)n.push(h[u])}var p=null;if(a){var f=a.getIntersection(t);if(null!==f&&(t.isAnEndpoint(f)||(p=f),!a.isAnEndpoint(f)))for(var _=this._splitSafely(a,f),g=0,m=_.length;g<m;g++)n.push(_[g])}if(null!==l||null!==p){var y=null;if(null===l)y=p;else if(null===p)y=l;else{y=du.comparePoints(l,p)<=0?l:p}this.queue.remove(t.rightSE),n.push(t.rightSE);for(var v=t.split(y),w=0,b=v.length;w<b;w++)n.push(v[w])}n.length>0?(this.tree.remove(t),n.push(e)):(this.segments.push(t),t.prev=o)}else{if(o&&a){var C=o.getIntersection(a);if(null!==C){if(!o.isAnEndpoint(C))for(var I=this._splitSafely(o,C),k=0,E=I.length;k<E;k++)n.push(I[k]);if(!a.isAnEndpoint(C))for(var T=this._splitSafely(a,C),S=0,x=T.length;S<x;S++)n.push(T[S])}}this.tree.remove(t)}return n}},{key:"_splitSafely",value:function(e,t){this.tree.remove(e);var n=e.rightSE;this.queue.remove(n);var i=e.split(t);return i.push(n),void 0===e.consumedBy&&this.tree.insert(e),i}}]),e}(),Cu="undefined"!=typeof process&&{}.POLYGON_CLIPPING_MAX_QUEUE_SIZE||1e6,Iu="undefined"!=typeof process&&{}.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS||1e6,ku=new(function(){function e(){Kh(this,e)}return Jh(e,[{key:"run",value:function(e,t,n){ku.type=e,ru.reset();for(var i=[new mu(t,!0)],r=0,s=n.length;r<s;r++)i.push(new mu(n[r],!1));if(ku.numMultiPolys=i.length,"difference"===ku.type)for(var o=i[0],a=1;a<i.length;)null!==Xh(i[a].bbox,o.bbox)?a++:i.splice(a,1);if("intersection"===ku.type)for(var l=0,c=i.length;l<c;l++)for(var h=i[l],u=l+1,d=i.length;u<d;u++)if(null===Xh(h.bbox,i[u].bbox))return[];for(var p=new Vh(du.compare),f=0,_=i.length;f<_;f++)for(var g=i[f].getSweepEvents(),m=0,y=g.length;m<y;m++)if(p.insert(g[m]),p.size>Cu)throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");for(var v=new bu(p),w=p.size,b=p.pop();b;){var C=b.key;if(p.size===w){var I=C.segment;throw new Error("Unable to pop() ".concat(C.isLeft?"left":"right"," SweepEvent ")+"[".concat(C.point.x,", ").concat(C.point.y,"] from segment #").concat(I.id," ")+"[".concat(I.leftSE.point.x,", ").concat(I.leftSE.point.y,"] -> ")+"[".concat(I.rightSE.point.x,", ").concat(I.rightSE.point.y,"] from queue. ")+"Please file a bug report.")}if(p.size>Cu)throw new Error("Infinite loop when passing sweep line over endpoints (queue size too big). Please file a bug report.");if(v.segments.length>Iu)throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments). Please file a bug report.");for(var k=v.process(C),E=0,T=k.length;E<T;E++){var S=k[E];void 0===S.consumedBy&&p.insert(S)}w=p.size,b=p.pop()}ru.reset();var x=yu.factory(v.segments);return new wu(x).getGeom()}}]),e}()),Eu={union:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return ku.run("union",e,n)},intersection:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return ku.run("intersection",e,n)},xor:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return ku.run("xor",e,n)},difference:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return ku.run("difference",e,n)}},Tu={exports:{}},Su=function(e,t){this.p1=e,this.p2=t};Su.prototype.rise=function(){return this.p2[1]-this.p1[1]},Su.prototype.run=function(){return this.p2[0]-this.p1[0]},Su.prototype.slope=function(){return this.rise()/this.run()},Su.prototype.yIntercept=function(){return this.p1[1]-this.p1[0]*this.slope(this.p1,this.p2)},Su.prototype.isVertical=function(){return!isFinite(this.slope())},Su.prototype.isHorizontal=function(){return this.p1[1]==this.p2[1]},Su.prototype._perpendicularDistanceHorizontal=function(e){return Math.abs(this.p1[1]-e[1])},Su.prototype._perpendicularDistanceVertical=function(e){return Math.abs(this.p1[0]-e[0])},Su.prototype._perpendicularDistanceHasSlope=function(e){var t=this.slope(),n=this.yIntercept();return Math.abs(t*e[0]-e[1]+n)/Math.sqrt(Math.pow(t,2)+1)},Su.prototype.perpendicularDistance=function(e){return this.isVertical()?this._perpendicularDistanceVertical(e):this.isHorizontal()?this._perpendicularDistanceHorizontal(e):this._perpendicularDistanceHasSlope(e)};var xu=Su,Ru=function(e,t){for(var n=0,i=0,r=1;r<=e.length-2;r++){var s=new xu(e[0],e[e.length-1]).perpendicularDistance(e[r]);s>n&&(i=r,n=s)}if(n>t)var o=Ru(e.slice(0,i),t),a=Ru(e.slice(i,e.length),t),l=o.concat(a);else l=e.length>1?[e[0],e[e.length-1]]:[e[0]];return l},Pu=Ru;!function(e){var t=Pu;function n(t,n){var i=t.geometry,r=i.type;if("LineString"===r)i.coordinates=e.exports.simplify(i.coordinates,n);else if("Polygon"===r||"MultiLineString"===r)for(var s=0;s<i.coordinates.length;s++)i.coordinates[s]=e.exports.simplify(i.coordinates[s],n);else if("MultiPolygon"===r)for(var o=0;o<i.coordinates.length;o++)for(var a=0;a<i.coordinates[o].length;a++)i.coordinates[o][a]=e.exports.simplify(i.coordinates[o][a],n);return t}e.exports=function(e,t,i){return i||(e=JSON.parse(JSON.stringify(e))),e.features?function(e,t){for(var i=0;i<e.features.length;i++)e.features[i]=n(e.features[i],t);return e}(e,t):e.type&&"Feature"===e.type?n(e,t):new Error("FeatureCollection or individual Feature required")},e.exports.simplify=function(e,n){return t(e,n)}}(Tu);var Nu=Tu.exports;export{ec as A,Fl as B,On as C,An as D,U as E,F,_h as G,mh as H,Ul as I,eh as J,Ll as K,Bl as L,Vl as M,Hl as N,zl as O,at as P,j as Q,p as a,f as b,g as c,Eu as d,Nu as e,L as f,_ as g,m as h,V as i,z as j,Fh as k,Xl as l,nh as m,Ai as n,v as o,$l as p,Kl as q,Al as r,B as s,W as t,y as u,Pn as v,Nn as w,Ml as x,th as y,Zc as z};
