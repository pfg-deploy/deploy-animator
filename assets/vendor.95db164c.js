 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var me=function(e){function t(n,i,r){var s=e.call(this,i)||this;return s.code=n,s.customData=r,s.name="FirebaseError",Object.setPrototypeOf(s,t.prototype),Error.captureStackTrace&&Error.captureStackTrace(s,ye.prototype.create),s}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");function n(){this.constructor=e}J(e,t),e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}(t,e),t}(Error),ye=function(){function e(e,t,n){this.service=e,this.serviceName=t,this.errors=n}return e.prototype.create=function(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];var i=t[0]||{},r=this.service+"/"+e,s=this.errors[e],o=s?ve(s,i):"Error",a=this.serviceName+": "+o+" ("+r+").",l=new me(r,a,i);return l},e}();function ve(e,t){return e.replace(we,(function(e,n){var i=t[n];return null!=i?String(i):"<"+n+"?>"}))}var we=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var We,ze,Be,Ve=function(){function e(e){this.name=e,this.providers=new Map}return e.prototype.addComponent=function(e){var t=this.getProvider(e.name);if(t.isComponentSet())throw new Error("Component "+e.name+" has already been registered with "+this.name);t.setComponent(e)},e.prototype.addOrOverwriteComponent=function(e){this.getProvider(e.name).isComponentSet()&&this.providers.delete(e.name),this.addComponent(e)},e.prototype.getProvider=function(e){if(this.providers.has(e))return this.providers.get(e);var t=new je(e,this);return this.providers.set(e,t),t},e.prototype.getProviders=function(){return Array.from(this.providers.values())},e}();
/*! *****************************************************************************
...
***************************************************************************** */function He(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length;var i=Array(e),r=0;for(t=0;t<n;t++)for(var s=arguments[t],o=0,a=s.length;o<a;o++,r++)i[r]=s[o];return i}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Be=ze||(ze={}))[Be.DEBUG=0]="DEBUG",Be[Be.VERBOSE=1]="VERBOSE",Be[Be.INFO=2]="INFO",Be[Be.WARN=3]="WARN",Be[Be.ERROR=4]="ERROR",Be[Be.SILENT=5]="SILENT";var Ge={debug:ze.DEBUG,verbose:ze.VERBOSE,info:ze.INFO,warn:ze.WARN,error:ze.ERROR,silent:ze.SILENT},$e=ze.INFO,Ke=((We={})[ze.DEBUG]="log",We[ze.VERBOSE]="log",We[ze.INFO]="info",We[ze.WARN]="warn",We[ze.ERROR]="error",We),Ye=function(e,t){for(var n=[],i=2;i<arguments.length;i++)n[i-2]=arguments[i];if(!(t<e.logLevel)){var r=(new Date).toISOString(),s=Ke[t];if(!s)throw new Error("Attempted to log a message with an invalid logType (value: "+t+")");console[s].apply(console,He(["["+r+"]  "+e.name+":"],n))}},Je=function(){function e(e){this.name=e,this._logLevel=$e,this._logHandler=Ye,this._userLogHandler=null}return Object.defineProperty(e.prototype,"logLevel",{get:function(){return this._logLevel},set:function(e){if(!(e in ze))throw new TypeError('Invalid value "'+e+'" assigned to `logLevel`');this._logLevel=e},enumerable:!1,configurable:!0}),e.prototype.setLogLevel=function(e){this._logLevel="string"==typeof e?Ge[e]:e},Object.defineProperty(e.prototype,"logHandler",{get:function(){return this._logHandler},set:function(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"userLogHandler",{get:function(){return this._userLogHandler},set:function(e){this._userLogHandler=e},enumerable:!1,configurable:!0}),e.prototype.debug=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,He([this,ze.DEBUG],e)),this._logHandler.apply(this,He([this,ze.DEBUG],e))},e.prototype.log=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,He([this,ze.VERBOSE],e)),this._logHandler.apply(this,He([this,ze.VERBOSE],e))},e.prototype.info=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,He([this,ze.INFO],e)),this._logHandler.apply(this,He([this,ze.INFO],e))},e.prototype.warn=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,He([this,ze.WARN],e)),this._logHandler.apply(this,He([this,ze.WARN],e))},e.prototype.error=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,He([this,ze.ERROR],e)),this._logHandler.apply(this,He([this,ze.ERROR],e))},e}();
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
ct("firebase","9.0.0","app");const ut=new ye("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),dt=new Je("@firebase/auth");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(e,...t){throw gt(e,...t)}function _t(e,...t){return gt(e,...t)}function gt(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return ut.create(e,...t)}function mt(e,t,...n){if(!e)throw gt(t,...n)}function yt(e){const t="INTERNAL ASSERTION FAILED: "+e;throw pt(t),new Error(t)}function vt(e,t){e||yt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt=new Map;function bt(e){vt(e instanceof Function,"Expected a class definition");let t=wt.get(e);return t?(vt(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,wt.set(e,t),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Et{constructor(e,t){this.shortDelay=e,this.longDelay=t,vt(t>e,"Short delay should be less than long delay!"),this.isMobile=fe()||_e()}get(){return kt()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(e,t){vt(e.emulator,"Emulator should always be set here");const{url:n}=e.emulator;return t?`${n}${t.startsWith("/")?t.slice(1):t}`:n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Vt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){mt(e.idToken,"internal-error"),mt(void 0!==e.idToken,"internal-error"),mt(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=qt(e);return mt(t,"internal-error"),mt(void 0!==t.exp,"internal-error"),mt(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return mt(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return yt("not implemented")}_getIdTokenResponse(e){return yt("not implemented")}_linkToIdToken(e,t){return yt("not implemented")}_getReauthenticationResolver(e){return yt("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn extends vn{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bn(){return void 0!==zn().WorkerGlobalScope&&"function"==typeof zn().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(n){this.reject(n)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return ei;case"linkViaPopup":case"linkViaRedirect":return ni;case"reauthViaPopup":case"reauthViaRedirect":return ti;default:ft(this.auth,"internal-error")}}resolve(e){vt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){vt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mi=new Et(3e4,6e4);function yi(){const e=zn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function vi(e){return new Promise(((t,n)=>{var i,r,s;function o(){yi(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{yi(),n(_t(e,"network-request-failed"))},timeout:mi.get()})}if(null===(r=null===(i=zn().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=zn().gapi)||void 0===s?void 0:s.load)){const t=`__${"iframefcb"}${Math.floor(1e6*Math.random())}`;return zn()[t]=()=>{gapi.load?o():n(_t(e,"network-request-failed"))},Xn(`https://apis.google.com/js/api.js?onload=${t}`)}o()}})).catch((e=>{throw wi=null,e}))}let wi=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Pe(a).slice(1)}`}const Pi=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Un,this._completeRedirectFn=ci}async _openPopup(e,t,n,i){var r;vt(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return xi(e,Ri(e,t,n,Ct(),i),jn())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Ri(e,t,n,Ct(),i),zn().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(vt(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n}async initAndGetManager(e){const t=await Ei(e),n=new hi(e);return t.register("authEvent",(t=>{mt(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),ft(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=_i(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ln()||Zt()||on()}};var Ni;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yr={},vr={};function wr(e){const t=e.toString();return yr[t]||(yr[t]=new mr),yr[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gs;const ms={};class ys{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return se(ms&&ds,"ChildrenNode.ts has not been loaded"),gs=gs||new ys({".priority":ms},{".priority":ds}),gs}get(e){const t=Ee(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ns?t:null}hasIndex(e){return ke(this.indexSet_,e.toString())}addIndex(e,t){se(e!==Zr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const r=t.getIterator(Yr.Wrap);let s,o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=r.getNext();s=i?_s(n,e.getCompare()):ms;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=s,new ys(c,l)}addToIndexes(e,t){const n=Se(this.indexes_,((n,i)=>{const r=Ee(this.indexSet_,i);if(se(r,"Missing index implementation for "+i),n===ms){if(r.isDefinedOn(e.node)){const n=[],i=t.getIterator(Yr.Wrap);let s=i.getNext();for(;s;)s.name!==e.name&&n.push(s),s=i.getNext();return n.push(e),_s(n,r.getCompare())}return ms}{const i=t.get(e.name);let r=n;return i&&(r=r.remove(new Yr(e.name,i))),r.insert(e,e.node)}}));return new ys(n,this.indexSet_)}removeFromIndexes(e,t){const n=Se(this.indexes_,(n=>{if(n===ms)return n;{const i=t.get(e.name);return i?n.remove(new Yr(e.name,i)):n}}));return new ys(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Vs,Hs;function Gs(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Hs=Vs||(Vs={}))[Hs.OVERWRITE=0]="OVERWRITE",Hs[Hs.MERGE=1]="MERGE",Hs[Hs.ACK_USER_WRITE=2]="ACK_USER_WRITE",Hs[Hs.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class $s{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Vs.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(jr(this.path)){if(null!=this.affectedTree.value)return se(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Nr(e));return new $s(Or(),t,this.revert)}}return se(Ar(this.path)===e,"operationForChild called for unrelated child."),new $s(Mr(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ks{constructor(e,t){this.source=e,this.path=t,this.type=Vs.LISTEN_COMPLETE}operationForChild(e){return jr(this.path)?new Ks(this.source,Or()):new Ks(this.source,Mr(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Vs.OVERWRITE}operationForChild(e){return jr(this.path)?new Ys(this.source,Or(),this.snap.getImmediateChild(e)):new Ys(this.source,Mr(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Vs.MERGE}operationForChild(e){if(jr(this.path)){const t=this.children.subtree(new Nr(e));return t.isEmpty()?null:t.value?new Ys(this.source,Or(),t.value):new Js(this.source,Or(),t)}return se(Ar(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Js(this.source,Mr(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(e,t,n,i,r){const s=new Ao;let o,a;if(n.type===Vs.OVERWRITE){const l=n;l.source.fromUser?o=qo(e,t,l.path,l.snap,i,r,s):(se(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!jr(l.path),o=Uo(e,t,l.path,l.snap,i,r,a,s))}else if(n.type===Vs.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,l)=>{const c=qr(n,i);jo(t,Ar(c))&&(a=qo(e,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=qr(n,i);jo(t,Ar(c))||(a=qo(e,a,c,l,r,s,o))})),a}(e,t,l.path,l.children,i,r,s):(se(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=zo(e,t,l.path,l.children,i,r,a,s))}else if(n.type===Vs.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=xo(i,n))return t;{const a=new Mo(i,t,r),l=t.eventCache.getNode();let c;if(jr(n)||".priority"===Ar(n)){let n;if(t.serverCache.isFullyInitialized())n=Eo(i,ro(t));else{const e=t.serverCache.getNode();se(e instanceof ws,"serverChildren would be complete if leaf node"),n=To(i,e)}n=n,c=e.filter.updateFullNode(l,n,s)}else{const r=Ar(n);let h=Po(i,r,t.serverCache);null==h&&t.serverCache.isCompleteForChild(r)&&(h=l.getImmediateChild(r)),c=null!=h?e.filter.updateChild(l,r,h,Mr(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(l,r,ws.EMPTY_NODE,Mr(n),a,s):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Eo(i,ro(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=xo(i,Or()),to(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Ba=/[\[\].#$\/\u0000-\u001F\u007F]/,Va=/[\[\].#$\u0000-\u001F\u007F]/,Ha=function(e){return"string"==typeof e&&0!==e.length&&!Ba.test(e)},Ga=function(e){return"string"==typeof e&&0!==e.length&&!Va.test(e)},$a=function(e){return null===e||"string"==typeof e||"number"==typeof e&&!Qi(e)||e&&"object"==typeof e&&ke(e,".sv")},Ka=function(e,t,n,i){i&&void 0===t||Ya(Le(e,"value"),t,n)},Ya=function(e,t,n){const i=n instanceof Nr?new Vr(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Gr(i));if("function"==typeof t)throw new Error(e+"contains a function "+Gr(i)+" with contents = "+t.toString());if(Qi(t))throw new Error(e+"contains "+t.toString()+" "+Gr(i));if("string"==typeof t&&t.length>10485760/3&&Fe(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Gr(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(sr(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!Ha(t)))throw new Error(e+" contains an invalid key ("+t+") "+Gr(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=Fe(a),Hr(o),Ya(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=Fe(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+Gr(i)+" in addition to actual children.")}},Ja=function(e,t,n,i){if(!(i&&void 0===n||Ga(n)))throw new Error(Le(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Qa=function(e,t){if(".info"===Ar(t))throw new Error(e+" failed = Can't modify data under /.info/")},Xa=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Ha(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Ga(e)}(n))throw new Error(Le(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Za{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function el(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||zr(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function tl(e,t,n){el(e,n),il(e,(e=>zr(e,t)))}function nl(e,t,n){el(e,n),il(e,(e=>Br(e,t)||Br(t,e)))}function il(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(rl(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function rl(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Vi&&Gi("event: "+n.toString()),cr(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sl{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Za,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=qs(),this.transactionQueueTree_=new Da,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function ol(e,t,n){if(e.stats_=wr(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Fs(e.repoInfo_,((t,n,i,r)=>{cl(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>hl(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ce(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}e.persistentConnection_=new Kr(e.repoInfo_,t,((t,n,i,r)=>{cl(e,t,n,i,r)}),(t=>{hl(e,t)}),(t=>{!function(e,t){sr(t,((t,n)=>{ul(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return vr[n]||(vr[n]=t()),vr[n]}(e.repoInfo_,(()=>new Bs(e.stats_,e.server_))),e.infoData_=new Us,e.infoSyncTree_=new ca({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=da(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),ul(e,"connected",!1),e.serverSyncTree_=new ca({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);nl(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function al(e){const t=e.infoData_.getNode(new Nr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function ll(e){return(t=(t={timestamp:al(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function cl(e,t,n,i,r){e.dataUpdateCount++;const s=new Nr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=Se(n,(e=>Cs(e)));o=function(e,t,n,i){const r=Ia(e,i);if(r){const i=ka(r),s=i.path,o=i.queryId,a=Wr(s,t),l=oo.fromObject(n);return Ea(e,s,new Js(Gs(o),a,l))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=Cs(n);o=function(e,t,n,i){const r=Ia(e,i);if(null!=r){const i=ka(r),s=i.path,o=i.queryId,a=Wr(s,t);return Ea(e,s,new Ys(Gs(o),a,n))}return[]}(e.serverSyncTree_,s,t,r)}else if(i){const t=Se(n,(e=>Cs(e)));o=function(e,t,n){const i=oo.fromObject(n);return ma(e,new Js({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=Cs(n);o=da(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=yl(e,s)),nl(e.eventQueue_,a,o)}function hl(e,t){ul(e,"connected",t),!1===t&&function(e){_l(e,"onDisconnectEvents");const t=ll(e),n=qs();Ws(e.onDisconnect_,Or(),((i,r)=>{const s=function(e,t,n,i){return Aa(t,new xa(n,e),i)}(i,r,e.serverSyncTree_,t);js(n,i,s)}));let i=[];Ws(n,Or(),((t,n)=>{i=i.concat(da(e.serverSyncTree_,t,n));const r=Il(e,t);yl(e,r)})),e.onDisconnect_=qs(),nl(e.eventQueue_,Or(),i)}(e)}function ul(e,t,n){const i=new Nr("/.info/"+t),r=Cs(n);e.infoData_.updateSnapshot(i,r);const s=da(e.infoSyncTree_,i,r);nl(e.eventQueue_,i,s)}function dl(e){return e.nextWriteId_++}function pl(e,t,n,i,r){_l(e,"set",{path:t.toString(),value:n,priority:i});const s=ll(e),o=Cs(n,i),a=_a(e.serverSyncTree_,t),l=Oa(o,a,s),c=dl(e),h=ha(e.serverSyncTree_,t,l,c,!0);el(e.eventQueue_,h),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||Ji("set at "+t+" failed: "+n);const o=ua(e.serverSyncTree_,c,!s);nl(e.eventQueue_,t,o),function(e,t,n,i){t&&cr((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}(0,r,n,i)}));const u=Il(e,t);yl(e,u),nl(e.eventQueue_,u,[])}function fl(e,t,n){let i;i=".info"===Ar(t._path)?pa(e.infoSyncTree_,t,n):pa(e.serverSyncTree_,t,n),tl(e.eventQueue_,t._path,i)}function _l(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Gi(n,...t)}function gl(e,t,n){return _a(e.serverSyncTree_,t,n)||ws.EMPTY_NODE}function ml(e,t=e.transactionQueueTree_){if(t||Cl(e,t),La(t)){const n=wl(e,t);se(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=gl(e,t,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const e=n[c];se(0===e.status,"tryToSendTransactionQueue_: items in queue should all be run."),e.status=1,e.retryCount++;const i=Wr(t,e.path);s=s.updateChild(i,e.currentOutputSnapshotRaw)}const a=s.val(!0),l=t;e.server_.put(l.toString(),a,(i=>{_l(e,"transaction put response",{path:l.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(ua(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Cl(e,Ma(e.transactionQueueTree_,t)),ml(e,e.transactionQueueTree_),nl(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)cr(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Ji("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}yl(e,t)}}),o)}(e,Wa(t),n)}else Ua(t)&&qa(t,(t=>{ml(e,t)}))}function yl(e,t){const n=vl(e,t),i=Wa(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=Wr(n,l.path);let h,u=!1;if(se(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)u=!0,h=l.abortReason,r=r.concat(ua(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)u=!0,h="maxretry",r=r.concat(ua(e.serverSyncTree_,l.currentWriteId,!0));else{const n=gl(e,l.path,s);l.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Ya("transaction failed: Data returned ",i,l.path);let t=Cs(i);"object"==typeof i&&null!=i&&ke(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=l.currentWriteId,a=ll(e),c=Oa(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=dl(e),s.splice(s.indexOf(o),1),r=r.concat(ha(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),r=r.concat(ua(e.serverSyncTree_,o,!0))}else u=!0,h="nodata",r=r.concat(ua(e.serverSyncTree_,l.currentWriteId,!0))}nl(e.eventQueue_,n,r),r=[],u&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===h?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(h),!1,null)))))}var o;Cl(e,e.transactionQueueTree_);for(let a=0;a<i.length;a++)cr(i[a]);ml(e,e.transactionQueueTree_)}(e,wl(e,n),i),i}function vl(e,t){let n,i=e.transactionQueueTree_;for(n=Ar(t);null!==n&&void 0===La(i);)i=Ma(i,n),n=Ar(t=Mr(t));return i}function wl(e,t){const n=[];return bl(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function bl(e,t,n){const i=La(t);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);qa(t,(t=>{bl(e,t,n)}))}function Cl(e,t){const n=La(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Fa(t,n.length>0?n:void 0)}qa(t,(t=>{Cl(e,t)}))}function Il(e,t){const n=Wa(vl(e,t)),i=Ma(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{kl(e,t)})),kl(e,i),ja(i,(t=>{kl(e,t)})),n}function kl(e,t){const n=La(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(se(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(se(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(ua(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Fa(t,void 0):n.length=s+1,nl(e.eventQueue_,Wa(t),r);for(let e=0;e<i.length;e++)cr(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sl{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Ce(this.snapshot.exportVal())}}class xl{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pl{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return jr(this._path)?null:Lr(this._path)}get ref(){return new Nl(this._repo,this._path)}get _queryIdentifier(){const e=Ls(this._queryParams),t=ir(e);return"{}"===t?"default":t}get _queryObject(){return Ls(this._queryParams)}isEqual(e){if(!((e=Ue(e))instanceof Pl))return!1;const t=this._repo===e._repo,n=zr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Nl extends Pl{constructor(e,t){super(e,t,new Ds,!1)}get parent(){const e=Ur(this._path);return null===e?null:new Nl(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Ol{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Nr(e),n=Dl(this.ref,e);return new Ol(this._node.getChild(t),n,ds)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ol(n,Dl(this.ref,t),ds))))}hasChild(e){const t=new Nr(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Al(e,t){return(e=Ue(e))._checkNotDeleted("ref"),void 0!==t?Dl(e._root,t):e._root}function Dl(e,t){var n,i,r,s;return null===Ar((e=Ue(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),Ja(n,i,r,s)):Ja("child","path",t,!1),new Nl(e._repo,qr(e._path,t))}function Ml(e,t){e=Ue(e),Qa("push",e._path),Ka("push",t,e._path,!0);const n=al(e._repo),i=Ts(n),r=Dl(e,i),s=Dl(e,i);let o;return o=null!=t?Ll(s,t).then((()=>s)):Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function Ll(e,t){e=Ue(e),Qa("set",e._path),Ka("set",t,e._path,!1);const n=new de;return pl(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Fl(e){return function(e,t){const n=ga(e.serverSyncTree_,t);return null!=n?Promise.resolve(n):e.server_.get(t).then((n=>{const i=Cs(n).withIndex(t._queryParams.getIndex()),r=da(e.serverSyncTree_,t._path,i);return tl(e.eventQueue_,t._path,r),Promise.resolve(i)}),(n=>(_l(e,"get for query "+Ce(t)+" failed: "+n),Promise.reject(new Error(n)))))}((e=Ue(e))._repo,e).then((t=>new Ol(t,new Nl(e._repo,e._path),e._queryParams.getIndex())))}class Ul{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Sl("value",this,new Ol(e.snapshotNode,new Nl(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new xl(this,e,t):null}matches(e){return e instanceof Ul&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class ql{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new xl(this,e,t):null}createEvent(e,t){se(null!=e.childName,"Child events should have a childName.");const n=Dl(new Nl(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Sl(e.type,this,new Ol(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ql&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function jl(e,t,n,i,r){let s;if("object"==typeof i&&(s=void 0,r=i),"function"==typeof i&&(s=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{fl(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Rl(n,s||void 0),a="value"===t?new Ul(o):new ql(t,o);return function(e,t,n){let i;i=".info"===Ar(t._path)?fa(e.infoSyncTree_,t,n):fa(e.serverSyncTree_,t,n),tl(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>fl(e._repo,e,a)}function Wl(e,t,n,i){return jl(e,"value",t,n,i)}function zl(e,t,n,i){return jl(e,"child_added",t,n,i)}function Bl(e,t,n,i){return jl(e,"child_changed",t,n,i)}function Vl(e,t,n,i){return jl(e,"child_removed",t,n,i)}class Hl extends class{}{constructor(e){super(),this._path=e}_apply(e){!function(e,t){if(!0===e._orderByCalled)throw new Error(t+": You can't combine multiple orderBy calls.")}(e,"orderByChild");const t=new Nr(this._path);if(jr(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const n=new Is(t),i=function(e,t){const n=e.copy();return n.index_=t,n}(e._queryParams,n);return function(e){let t=null,n=null;if(e.hasStart()&&(t=e.getIndexStartValue()),e.hasEnd()&&(n=e.getIndexEndValue()),e.getIndex()===Zr){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",r="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(e.hasStart()){if(e.getIndexStartName()!==Xi)throw new Error(i);if("string"!=typeof t)throw new Error(r)}if(e.hasEnd()){if(e.getIndexEndName()!==Zi)throw new Error(i);if("string"!=typeof n)throw new Error(r)}}else if(e.getIndex()===ds){if(null!=t&&!$a(t)||null!=n&&!$a(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(se(e.getIndex()instanceof Is||e.getIndex()===ks,"unknown index type."),null!=t&&"object"==typeof t||null!=n&&"object"==typeof n)throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}(i),new Pl(e._repo,e._path,i,!0)}}function Gl(e){if("$key"===e)throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if("$priority"===e)throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if("$value"===e)throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return Ja("orderByChild","path",e,!1),new Hl(e)}function $l(e,...t){let n=Ue(e);for(const i of t)n=i._apply(n);return n}!function(e){se(!Yo,"__referenceConstructor has already been defined"),Yo=e}(Nl),function(e){se(!Jo,"__referenceConstructor has already been defined"),Jo=e}(Nl);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Kl={};function Yl(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Yi("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Gi("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=El(s,r),c=l.repoInfo;"undefined"!=typeof process&&(a=process.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=El(s,r),c=l.repoInfo):o=!l.repoInfo.secure;const h=r&&o?new pr(pr.OWNER):new dr(e.name,e.options,t);Xa("Invalid Firebase Database URL",l),jr(l.path)||Yi("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=Kl[t.name];r||(r={},Kl[t.name]=r);let s=r[e.toURLString()];s&&Yi("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new sl(e,false,n,i),r[e.toURLString()]=s,s}(c,e,h,new ur(e.name,n));return new Jl(u,e)}class Jl{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(ol(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Nl(this._repo,Or())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Kl[t];n&&n[e.key]===e||Yi(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Yi("Cannot call "+e+" on a deleted database.")}}function Ql(e=lt(),t){return rt(e,"database").getImmediate({identifier:t})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const Xl={".sv":"timestamp"};function Zl(){return Xl}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var ec,tc;Kr.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Kr.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){Di="9.0.0",it(new qe("database",((e,{instanceIdentifier:t})=>Yl(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ct("@firebase/database","0.12.0",e)}(),(tc=ec||(ec={}))[tc.NO_ERROR=0]="NO_ERROR",tc[tc.NETWORK_ERROR=1]="NETWORK_ERROR",tc[tc.ABORT=2]="ABORT";class nc extends me{constructor(e,t){super(ic(e),`Firebase Storage: ${t} (${ic(e)})`),this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,nc.prototype)}_codeEquals(e){return ic(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}function ic(e){return"storage/"+e}function rc(){return new nc("unknown","An unknown error occurred, please check the error payload for server response.")}function sc(e){return new nc("invalid-argument",e)}function oc(){return new nc("app-deleted","The Firebase app was deleted.")}function ac(e,t){return new nc("invalid-format","String does not match format '"+e+"': "+t)}function lc(e){throw new nc("internal-error","Internal error: "+e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cc{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.errorCode_=ec.NO_ERROR,this.sendPromise_=new Promise((e=>{this.xhr_.addEventListener("abort",(()=>{this.errorCode_=ec.ABORT,e()})),this.xhr_.addEventListener("error",(()=>{this.errorCode_=ec.NETWORK_ERROR,e()})),this.xhr_.addEventListener("load",(()=>{e()}))}))}send(e,t,n,i){if(this.sent_)throw lc("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(t,e,!0),void 0!==i)for(const r in i)i.hasOwnProperty(r)&&this.xhr_.setRequestHeader(r,i[r].toString());return void 0!==n?this.xhr_.send(n):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw lc("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw lc("cannot .getStatus() before sending");try{return this.xhr_.status}catch(e){return-1}}getResponseText(){if(!this.sent_)throw lc("cannot .getResponseText() before sending");return this.xhr_.responseText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.removeEventListener("progress",e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class hc{createConnection(){return new cc}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uc{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=uc.makeFromUrl(e,t)}catch(i){return new uc(e,"")}if(""===n.path)return n;throw new nc("invalid-default-bucket","Invalid default bucket '"+e+"'.")}static makeFromUrl(e,t){let n=null;const i="([A-Za-z0-9.\\-_]+)";const r=new RegExp("^gs://"+i+"(/(.*))?$","i");function s(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:r,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${i}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:s},{regex:new RegExp(`^https?://${"firebasestorage.googleapis.com"===t?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${i}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:s}];for(let l=0;l<a.length;l++){const t=a[l],i=t.regex.exec(e);if(i){const e=i[t.indices.bucket];let r=i[t.indices.path];r||(r=""),n=new uc(e,r),t.postModify(n);break}}if(null==n)throw function(e){return new nc("invalid-url","Invalid URL '"+e+"'.")}(e);return n}}class dc{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pc(e){return"string"==typeof e||e instanceof String}function fc(e){return _c()&&e instanceof Blob}function _c(){return"undefined"!=typeof Blob}function gc(e,t,n,i){if(i<t)throw sc(`Invalid value for '${e}'. Expected ${t} or greater.`);if(i>n)throw sc(`Invalid value for '${e}'. Expected ${n} or less.`)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mc(e,t){const n=t.match(/^(\w+):\/\/.+/);let i=t;return null==(null==n?void 0:n[1])&&(i=`https://${t}`),`${i}/v0${e}`}function yc(e){const t=encodeURIComponent;let n="?";for(const i in e)if(e.hasOwnProperty(i)){n=n+(t(i)+"="+t(e[i]))+"&"}return n=n.slice(0,-1),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vc{constructor(e,t,n,i,r,s,o,a,l,c,h){this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.url_=e,this.method_=t,this.headers_=n,this.body_=i,this.successCodes_=r.slice(),this.additionalRetryCodes_=s.slice(),this.callback_=o,this.errorCallback_=a,this.progressCallback_=c,this.timeout_=l,this.pool_=h,this.promise_=new Promise(((e,t)=>{this.resolve_=e,this.reject_=t,this.start_()}))}start_(){const e=this;function t(t,n){const i=e.resolve_,r=e.reject_,s=n.connection;if(n.wasSuccessCode)try{const t=e.callback_(s,s.getResponseText());void 0!==t?i(t):i()}catch(o){r(o)}else if(null!==s){const t=rc();t.serverResponse=s.getResponseText(),e.errorCallback_?r(e.errorCallback_(s,t)):r(t)}else if(n.canceled){r(e.appDelete_?oc():new nc("canceled","User canceled the upload/download."))}else{r(new nc("retry-limit-exceeded","Max retry time for operation exceeded, please try again."))}}this.canceled_?t(0,new wc(!1,null,!0)):this.backoffId_=function(e,t,n){let i=1,r=null,s=!1,o=0;function a(){return 2===o}let l=!1;function c(...e){l||(l=!0,t.apply(null,e))}function h(t){r=setTimeout((()=>{r=null,e(u,a())}),t)}function u(e,...t){if(l)return;if(e)return void c.call(null,e,...t);if(a()||s)return void c.call(null,e,...t);let n;i<64&&(i*=2),1===o?(o=2,n=0):n=1e3*(i+Math.random()),h(n)}let d=!1;function p(e){d||(d=!0,l||(null!==r?(e||(o=2),clearTimeout(r),h(0)):e||(o=1)))}return h(0),setTimeout((()=>{s=!0,p(!0)}),n),p}((function(t,n){if(n)return void t(!1,new wc(!1,null,!0));const i=e.pool_.createConnection();function r(t){const n=t.loaded,i=t.lengthComputable?t.total:-1;null!==e.progressCallback_&&e.progressCallback_(n,i)}e.pendingConnection_=i,null!==e.progressCallback_&&i.addUploadProgressListener(r),i.send(e.url_,e.method_,e.body_,e.headers_).then((()=>{null!==e.progressCallback_&&i.removeUploadProgressListener(r),e.pendingConnection_=null;const n=i.getErrorCode()===ec.NO_ERROR,s=i.getStatus();if(!n||e.isRetryStatusCode_(s)){const e=i.getErrorCode()===ec.ABORT;return void t(!1,new wc(!1,null,e))}const o=-1!==e.successCodes_.indexOf(s);t(!0,new wc(o,i))}))}),t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,null!==this.backoffId_&&(0,this.backoffId_)(!1),null!==this.pendingConnection_&&this.pendingConnection_.abort()}isRetryStatusCode_(e){const t=e>=500&&e<600,n=-1!==[408,429].indexOf(e),i=-1!==this.additionalRetryCodes_.indexOf(e);return t||n||i}}class wc{constructor(e,t,n){this.wasSuccessCode=e,this.connection=t,this.canceled=!!n}}function bc(...e){const t="undefined"!=typeof BlobBuilder?BlobBuilder:"undefined"!=typeof WebKitBlobBuilder?WebKitBlobBuilder:void 0;if(void 0!==t){const n=new t;for(let t=0;t<e.length;t++)n.append(e[t]);return n.getBlob()}if(_c())return new Blob(e);throw new nc("unsupported-environment","This browser doesn't seem to support creating Blobs")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Cc="raw",Ic="base64",kc="base64url",Ec="data_url";class Tc{constructor(e,t){this.data=e,this.contentType=t||null}}function Sc(e,t){switch(e){case Cc:return new Tc(xc(t));case Ic:case kc:return new Tc(Rc(e,t));case Ec:return new Tc(function(e){const t=new Pc(e);return t.base64?Rc(Ic,t.rest):function(e){let t;try{t=decodeURIComponent(e)}catch(n){throw ac(Ec,"Malformed data URL.")}return xc(t)}(t.rest)}(t),new Pc(t).contentType)}throw rc()}function xc(e){const t=[];for(let n=0;n<e.length;n++){let i=e.charCodeAt(n);if(i<=127)t.push(i);else if(i<=2047)t.push(192|i>>6,128|63&i);else if(55296==(64512&i)){if(n<e.length-1&&56320==(64512&e.charCodeAt(n+1))){i=65536|(1023&i)<<10|1023&e.charCodeAt(++n),t.push(240|i>>18,128|i>>12&63,128|i>>6&63,128|63&i)}else t.push(239,191,189)}else 56320==(64512&i)?t.push(239,191,189):t.push(224|i>>12,128|i>>6&63,128|63&i)}return new Uint8Array(t)}function Rc(e,t){switch(e){case Ic:{const n=-1!==t.indexOf("-"),i=-1!==t.indexOf("_");if(n||i){throw ac(e,"Invalid character '"+(n?"-":"_")+"' found: is it base64url encoded?")}break}case kc:{const n=-1!==t.indexOf("+"),i=-1!==t.indexOf("/");if(n||i){throw ac(e,"Invalid character '"+(n?"+":"/")+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=atob(t)}catch(r){throw ac(e,"Invalid character found")}const i=new Uint8Array(n.length);for(let s=0;s<n.length;s++)i[s]=n.charCodeAt(s);return i}class Pc{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw ac(Ec,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=function(e,t){if(!(e.length>=t.length))return!1;return e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-";base64".length):n),this.rest=e.substring(e.indexOf(",")+1)}}class Nc{constructor(e,t){let n=0,i="";fc(e)?(this.data_=e,n=e.size,i=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,t){if(fc(this.data_)){const s=this.data_,o=(i=e,r=t,(n=s).webkitSlice?n.webkitSlice(i,r):n.mozSlice?n.mozSlice(i,r):n.slice?n.slice(i,r):null);return null===o?null:new Nc(o)}{const n=new Uint8Array(this.data_.buffer,e,t-e);return new Nc(n,!0)}var n,i,r;
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}static getBlob(...e){if(_c()){const t=e.map((e=>e instanceof Nc?e.data_:e));return new Nc(bc.apply(null,t))}{const t=e.map((e=>pc(e)?Sc(Cc,e).data:e.data_));let n=0;t.forEach((e=>{n+=e.byteLength}));const i=new Uint8Array(n);let r=0;return t.forEach((e=>{for(let t=0;t<e.length;t++)i[r++]=e[t]})),new Nc(i,!0)}}uploadData(){return this.data_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oc(e){let t;try{t=JSON.parse(e)}catch(i){return null}return"object"!=typeof(n=t)||Array.isArray(n)?null:t;var n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ac(e){const t=e.lastIndexOf("/",e.length-2);return-1===t?e:e.slice(t+1)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dc(e,t){return t}class Mc{constructor(e,t,n,i){this.server=e,this.local=t||e,this.writable=!!n,this.xform=i||Dc}}let Lc=null;function Fc(){if(Lc)return Lc;const e=[];e.push(new Mc("bucket")),e.push(new Mc("generation")),e.push(new Mc("metageneration")),e.push(new Mc("name","fullPath",!0));const t=new Mc("name");t.xform=function(e,t){return function(e){return!pc(e)||e.length<2?e:Ac(e)}(t)},e.push(t);const n=new Mc("size");return n.xform=function(e,t){return void 0!==t?Number(t):t},e.push(n),e.push(new Mc("timeCreated")),e.push(new Mc("updated")),e.push(new Mc("md5Hash",null,!0)),e.push(new Mc("cacheControl",null,!0)),e.push(new Mc("contentDisposition",null,!0)),e.push(new Mc("contentEncoding",null,!0)),e.push(new Mc("contentLanguage",null,!0)),e.push(new Mc("contentType",null,!0)),e.push(new Mc("metadata","customMetadata",!0)),Lc=e,Lc}function Uc(e,t,n){const i={type:"file"},r=n.length;for(let s=0;s<r;s++){const e=n[s];i[e.local]=e.xform(i,t[e.server])}return function(e,t){Object.defineProperty(e,"ref",{get:function(){const n=e.bucket,i=e.fullPath,r=new uc(n,i);return t._makeStorageReference(r)}})}(i,e),i}function qc(e,t,n){const i=Oc(t);if(null===i)return null;return Uc(e,i,n)}class jc{constructor(e,t,n,i){this.url=e,this.method=t,this.handler=n,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wc(e){if(!e)throw rc()}function zc(e,t){return function(n,i){const r=qc(e,i,t);return Wc(null!==r),function(e,t,n){const i=Oc(t);if(null===i)return null;if(!pc(i.downloadTokens))return null;const r=i.downloadTokens;if(0===r.length)return null;const s=encodeURIComponent;return r.split(",").map((t=>{const i=e.bucket,r=e.fullPath;return mc("/b/"+s(i)+"/o/"+s(r),n)+yc({alt:"media",token:t})}))[0]}(r,i,e.host)}}function Bc(e){return function(t,n){let i;var r,s;return 401===t.getStatus()?i=t.getResponseText().includes("Firebase App Check token is invalid")?new nc("unauthorized-app","This app does not have permission to access Firebase Storage on this project."):new nc("unauthenticated","User is not authenticated, please authenticate using Firebase Authentication and try again."):402===t.getStatus()?(s=e.bucket,i=new nc("quota-exceeded","Quota for bucket '"+s+"' exceeded, please view quota on https://firebase.google.com/pricing/.")):403===t.getStatus()?(r=e.path,i=new nc("unauthorized","User does not have permission to access '"+r+"'.")):i=n,i.serverResponse=n.serverResponse,i}}function Vc(e){const t=Bc(e);return function(n,i){let r=t(n,i);var s;return 404===n.getStatus()&&(s=e.path,r=new nc("object-not-found","Object '"+s+"' does not exist.")),r.serverResponse=i.serverResponse,r}}function Hc(e,t,n,i,r){const s=t.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};const a=function(){let e="";for(let t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}();o["Content-Type"]="multipart/related; boundary="+a;const l=function(e,t,n){const i=Object.assign({},n);return i.fullPath=e.path,i.size=t.size(),i.contentType||(i.contentType=function(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}(null,t)),i}(t,i,r),c="--"+a+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+function(e,t){const n={},i=t.length;for(let r=0;r<i;r++){const i=t[r];i.writable&&(n[i.server]=e[i.local])}return JSON.stringify(n)}(l,n)+"\r\n--"+a+"\r\nContent-Type: "+l.contentType+"\r\n\r\n",h="\r\n--"+a+"--",u=Nc.getBlob(c,i,h);if(null===u)throw new nc("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.");const d={name:l.fullPath},p=mc(s,e.host),f=e.maxUploadRetryTime,_=new jc(p,"POST",function(e,t){return function(n,i){const r=qc(e,i,t);return Wc(null!==r),r}}(e,n),f);return _.urlParams=d,_.headers=o,_.body=u.uploadData(),_.errorHandler=Bc(t),_}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gc{constructor(e,t){this._service=e,this._location=t instanceof uc?t:uc.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Gc(e,t)}get root(){const e=new uc(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Ac(this._location.path)}get storage(){return this._service}get parent(){const e=function(e){if(0===e.length)return null;const t=e.lastIndexOf("/");return-1===t?"":e.slice(0,t)}(this._location.path);if(null===e)return null;const t=new uc(this._location.bucket,e);return new Gc(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw function(e){return new nc("invalid-root-operation","The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}(e)}}async function $c(e){e._throwIfRoot("getDownloadURL");const t=function(e,t,n){const i=mc(t.fullServerUrl(),e.host),r=e.maxOperationRetryTime,s=new jc(i,"GET",zc(e,n),r);return s.errorHandler=Vc(t),s}(e.storage,e._location,Fc());return(await e.storage.makeRequestWithTokens(t)).getPromise().then((e=>{if(null===e)throw new nc("no-download-url","The given file does not have any download URLs.");return e}))}function Kc(e,t){if(e instanceof Qc){const n=e;if(null==n._bucket)throw new nc("no-default-bucket","No default bucket found. Did you set the 'storageBucket' property when initializing the app?");const i=new Gc(n,n._bucket);return null!=t?Kc(i,t):i}return void 0!==t?function(e,t){const n=function(e,t){const n=t.split("/").filter((e=>e.length>0)).join("/");return 0===e.length?n:e+"/"+n}(e._location.path,t),i=new uc(e._location.bucket,n);return new Gc(e.storage,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t):e}function Yc(e,t){if(t&&/^[A-Za-z]+:\/\//.test(t)){if(e instanceof Qc)return new Gc(e,t);throw sc("To use ref(service, url), the first argument must be a Storage instance.")}return Kc(e,t)}function Jc(e,t){const n=null==t?void 0:t.storageBucket;return null==n?null:uc.makeFromBucketSpec(n,e)}class Qc{constructor(e,t,n,i,r,s){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._pool=i,this._url=r,this._firebaseVersion=s,this._bucket=null,this._host="firebasestorage.googleapis.com",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=r?uc.makeFromBucketSpec(r,this._host):Jc(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=uc.makeFromBucketSpec(this._url,e):this._bucket=Jc(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){gc("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){gc("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){return(await e.getToken()).token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((e=>e.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new Gc(this,e)}_makeRequest(e,t,n){if(this._deleted)return new dc(oc());{const i=function(e,t,n,i,r,s){const o=yc(e.urlParams),a=e.url+o,l=Object.assign({},e.headers);return function(e,t){t&&(e["X-Firebase-GMPID"]=t)}(l,t),function(e,t){null!==t&&t.length>0&&(e.Authorization="Firebase "+t)}(l,n),function(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(null!=t?t:"AppManager")}(l,s),function(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}(l,i),new vc(a,e.method,l,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xc(e,t,n){return function(e,t,n){e._throwIfRoot("uploadBytes");const i=Hc(e.storage,e._location,Fc(),new Nc(t,!0),n);return e.storage.makeRequestWithTokens(i).then((e=>e.getPromise())).then((t=>({metadata:t,ref:e})))}(e=Ue(e),t,n)}function Zc(e){return $c(e=Ue(e))}function eh(e,t){return Yc(e=Ue(e),t)}function th(e=lt(),t){return rt(e=Ue(e),"storage").getImmediate({identifier:t})}function nh(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new Qc(n,i,r,new hc,t,"9.0.0")}it(new qe("storage",nh,"PUBLIC").setMultipleInstances(!0)),ct("@firebase/storage","0.8.0");const ih=Symbol("store-raw"),rh=Symbol("store-node"),sh=Symbol("store-name");function oh(t,n){let i=t[e];if(!i){Object.defineProperty(t,e,{value:i=new Proxy(t,uh)});const n=Object.keys(t),r=Object.getOwnPropertyDescriptors(t);for(let e=0,s=n.length;e<s;e++){const s=n[e];if(r[s].get){const e=r[s].get.bind(i);Object.defineProperty(t,s,{get:e})}}}return i}function ah(e){return null!=e&&"object"==typeof e&&(!e.__proto__||e.__proto__===Object.prototype||Array.isArray(e))}function lh(e,t=new Set){let n,i,r,s;if(n=null!=e&&e[ih])return n;if(!ah(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let n=0,s=e.length;n<s;n++)r=e[n],(i=lh(r,t))!==r&&(e[n]=i)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const n=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let a=0,l=n.length;a<l;a++)s=n[a],o[s].get||(r=e[s],(i=lh(r,t))!==r&&(e[s]=i))}return e}function ch(e){let t=e[rh];return t||Object.defineProperty(e,rh,{value:t={}}),t}function hh(){const[e,t]=p(void 0,{equals:!1,internal:!0});return e.$=t,e}const uh={get(t,n,i){if(n===ih)return t;if(n===e)return i;const r=t[n];if(n===rh||"__proto__"===n)return r;const s=ah(r);if(w()&&("function"!=typeof r||t.hasOwnProperty(n))){let e,i;s&&(e=ch(r))&&(i=e._||(e._=hh()),i()),e=ch(t),i=e[n]||(e[n]=hh()),i()}return s?oh(r):r},set:()=>!0,deleteProperty:()=>!0,ownKeys:function(e){if(w()){const t=ch(e);(t._||(t._=hh()))()}return Reflect.ownKeys(e)},getOwnPropertyDescriptor:function(t,n){const i=Reflect.getOwnPropertyDescriptor(t,n);return!i||i.get||n===e||n===rh||n===sh||(delete i.value,delete i.writable,i.get=()=>t[e][n]),i}};function dh(e,t,n){if(e[t]===n)return;const i=Array.isArray(e),r=e.length,s=void 0===n,o=i||s===t in e;s?delete e[t]:e[t]=n;let a,l=ch(e);(a=l[t])&&a.$(),i&&e.length!==r&&(a=l.length)&&a.$(a,void 0),o&&(a=l._)&&a.$(a,void 0)}function ph(e,t,n=[]){let i,r=e;if(t.length>1){i=t.shift();const s=typeof i,o=Array.isArray(e);if(Array.isArray(i)){for(let r=0;r<i.length;r++)ph(e,[i[r]].concat(t),[i[r]].concat(n));return}if(o&&"function"===s){for(let r=0;r<e.length;r++)i(e[r],r)&&ph(e,[r].concat(t),[r].concat(n));return}if(o&&"object"===s){const{from:r=0,to:s=e.length-1,by:o=1}=i;for(let i=r;i<=s;i+=o)ph(e,[i].concat(t),[i].concat(n));return}if(t.length>1)return void ph(e[i],t,[i].concat(n));r=e[i],n=[i].concat(n)}let s=t[0];"function"==typeof s&&(s=s(r,n),s===r)||void 0===i&&null==s||(s=lh(s),void 0===i||ah(r)&&ah(s)&&!Array.isArray(s)?function(e,t){const n=Object.keys(t);for(let i=0;i<n.length;i+=1){const r=n[i];dh(e,r,t[r])}}(r,s):dh(e,i,s))}function fh(e,t){const n=lh(e||{});return[oh(n),function(...e){m((()=>ph(n,e)))}]}function _h(e,t,n,i,r){const s=t[n];if(e===s)return;if(!ah(e)||!ah(s)||r&&e[r]!==s[r])return void(e!==s&&dh(t,n,e));if(Array.isArray(e)){if(e.length&&s.length&&(!i||r&&null!=e[0][r])){let t,n,o,a,l,c,h,u;for(o=0,a=Math.min(s.length,e.length);o<a&&(s[o]===e[o]||r&&s[o][r]===e[o][r]);o++)_h(e[o],s,o,i,r);const d=new Array(e.length),p=new Map;for(a=s.length-1,l=e.length-1;a>=o&&l>=o&&(s[a]===e[l]||r&&s[a][r]===e[l][r]);a--,l--)d[l]=s[a];if(o>l||o>a){for(n=o;n<=l;n++)dh(s,n,e[n]);for(;n<e.length;n++)dh(s,n,d[n]),_h(e[n],s,n,i,r);return void(s.length>e.length&&dh(s,"length",e.length))}for(h=new Array(l+1),n=l;n>=o;n--)c=e[n],u=r?c[r]:c,t=p.get(u),h[n]=void 0===t?-1:t,p.set(u,n);for(t=o;t<=a;t++)c=s[t],u=r?c[r]:c,n=p.get(u),void 0!==n&&-1!==n&&(d[n]=s[t],n=h[n],p.set(u,n));for(n=o;n<e.length;n++)n in d?(dh(s,n,d[n]),_h(e[n],s,n,i,r)):dh(s,n,e[n])}else for(let t=0,n=e.length;t<n;t++)_h(e[t],s,t,i,r);return void(s.length>e.length&&dh(s,"length",e.length))}const o=Object.keys(e);for(let l=0,c=o.length;l<c;l++)_h(e[o[l]],s,o[l],i,r);const a=Object.keys(s);for(let l=0,c=a.length;l<c;l++)void 0===e[a[l]]&&dh(s,a[l],void 0)}function gh(e,t={}){const{merge:n,key:i="id"}=t,r=lh(e);return e=>{const t=e;return ah(t)&&ah(r)?(_h(r,{state:t},"state",n,i),t):r}}function mh(e,t){return[e[0]+t[0],e[1]+t[1]]}function yh(e,t){return[e[0]-t[0],e[1]-t[1]]}function vh(e,t){return[t[0]-e[0],t[1]-e[1]]}function wh(e,t){return[e[0]*t,e[1]*t]}function bh(e){return[e[1],-e[0]]}function Ch(e,t){return e[0]*t[0]+e[1]*t[1]}function Ih(e,t){return function(e){return e[0]*e[0]+e[1]*e[1]}(yh(e,t))}function kh(e){return function(e,t){return[e[0]/t,e[1]/t]}(e,function(e){return Math.hypot(e[0],e[1])}(e))}function Eh(e,t){return Math.hypot(e[1]-t[1],e[0]-t[0])}function Th(e,t,n){let i=Math.sin(n),r=Math.cos(n),s=e[0]-t[0],o=e[1]-t[1],a=s*i+o*r;return[s*r-o*i+t[0],a+t[1]]}function Sh(e,t,n){return mh(e,wh(vh(e,t),n))}function xh(e,t){return e[0]===t[0]&&e[1]===t[1]}function Rh(e,t,n){return e*(1-n)+t*n}function Ph(e,t,n){return Math.max(t,Math.min(n,e))}function Nh(e,t,n,i=.5){return t?(i=Ph(n(i),0,1),(t<0?Rh(e,e+e*Ph(t,-.95,-.05),i):Rh(e-e*Ph(t,.05,.95),e,i))/2):e/2}var{min:Oh,PI:Ah}=Math;function Dh(e,t={}){let{streamline:n=.5}=t,{simulatePressure:i=!0}=t;n/=i?4:2;let r=function(e){return Array.isArray(e[0])?e.map((([e,t,n=.5])=>[e,t,n])):e.map((({x:e,y:t,pressure:n=.5})=>[e,t,n]))}(e);if(0===r.length)return[];1===r.length&&r.push([...mh(r[0],[1,1]),r[0][2]]);let s=[{point:[r[0][0],r[0][1]],pressure:r[0][2],vector:[0,0],distance:0,runningLength:0}];for(let o=1,a=0,l=r[o],c=s[a];o<r.length;o++,l=r[o],c=s[a]){let e=Sh(c.point,l,1-n);if(xh(c.point,e))continue;let t=kh(yh(c.point,e)),i=Eh(e,c.point),r=c.runningLength+i,o={point:e,pressure:l[2],vector:t,distance:i,runningLength:r};s.push(o),a+=1}return s}function Mh(e,t={}){let{size:n=8,thinning:i=.5,smoothing:r=.5,simulatePressure:s=!0,easing:o=(e=>e),start:a={},end:l={},last:c=!1}=t,{streamline:h=.5}=t;h/=2;let{cap:u=!0,taper:d=0,easing:p=(e=>e*(2-e))}=a,{cap:f=!0,taper:_=0,easing:g=(e=>--e*e*e+1)}=l,m=e.length;if(0===m)return[];let y=e[m-1].runningLength,v=[],w=[],b=e.slice(0,5).reduce(((e,t)=>(e+t.pressure)/2),e[0].pressure),C=Nh(n,i,o,e[m-1].pressure),I=e[0].vector,k=e[0].point,E=k,T=k,S=E,x=!0;for(let D=0;D<m-1;D++){let{pressure:t}=e[D],{point:a,vector:l,distance:c,runningLength:u}=e[D];if(D>0&&x&&u<n/2)continue;if(x&&(x=!1),i){if(s){let e=Oh(1,1-c/n),i=Oh(1,c/n);t=Oh(1,b+i/2*(e-b))}C=Nh(n,i,o,t)}else C=n/2;let f=u<d?p(u/d):1,m=y-u<_?g((y-u)/_):1;C=Math.max(.01,C*Math.min(f,m));let R=e[D+1].vector,P=Ch(l,R);if(P<0){let e=wh(bh(I),C);for(let t=0;t<1;t+=.2)S=Th(mh(a,e),a,Ah*-t),T=Th(yh(a,e),a,Ah*t),w.push(S),v.push(T);k=T,E=S;continue}let N=wh(bh(Sh(R,l,P)),C);T=yh(a,N),S=mh(a,N);let O=D<2||P<.25,A=Math.pow(Math.max((u>n?n:n/2)*r,1),2);(O||Ih(k,T)>A)&&(v.push(Sh(k,T,h)),k=T),(O||Ih(E,S)>A)&&(w.push(Sh(E,S,h)),E=S),b=t,I=l}let R=e[0],P=e[m-1],N=x||w.length<2||v.length<2;if(N&&(!d&&!_||c)){let t=0;for(let a=0;a<m;a++){let{pressure:r,runningLength:s}=e[a];if(s>n){t=Nh(n,i,o,r);break}}let r=yh(R.point,wh(bh(kh(vh(P.point,R.point))),t||C)),s=[];for(let e=0,n=.1;e<=1;e+=n)s.push(Th(r,R.point,2*Ah*e));return s}let O=[],A=[];if(v.length>1&&w.length>1){S=w[1];for(let t=1;t<v.length;t++)if(!xh(S,v[t])){T=v[t];break}if(u||d){if(d||_&&N)O.push(R.point,mh(R.point,[.1,.1]));else if(!xh(S,T)){let e=yh(R.point,wh(kh(vh(S,T)),Eh(S,T)/2));for(let t=0,n=.1;t<=1;t+=n)O.push(Th(e,R.point,Ah*t));v.shift(),w.shift()}}else if(!xh(S,T)){let e=kh(vh(S,T)),t=Eh(S,T)/2;O.push(yh(R.point,wh(e,.95*t))),O.push(yh(R.point,wh(e,t))),O.push(mh(R.point,wh(e,t))),O.push(mh(R.point,wh(e,.95*t))),v.shift(),w.shift()}let e=function(e,t){return wh(mh(e,t),.5)}(v[v.length-1],w[w.length-1]),n=t.last?P.point:Sh(e,P.point,.618),i=kh(yh(n,e));if(f||_)if(_||d&&N)A.push(n);else{let e=mh(n,wh(bh(i),C));for(let t=0,i=.15;t<=1;t+=i)A.push(Th(e,n,3*Ah*t))}else{let t=Sh(e,n,.95),r=.95*C;A.push(mh(t,wh(bh(i),r))),A.push(mh(n,wh(bh(i),r))),A.push(yh(n,wh(bh(i),r))),A.push(yh(t,wh(bh(i),r)))}}return v.concat(A,w.reverse(),O)}function Lh(e,t={}){return Mh(Dh(e,t),t)}
/**
 * splaytree v3.1.0
 ...
 * @license MIT
 * @preserve
 */var Fh=function(e,t){this.next=null,this.key=e,this.data=t,this.left=null,this.right=null};function Uh(e,t){return e>t?1:e<t?-1:0}function qh(e,t,n){for(var i=new Fh(null,null),r=i,s=i;;){var o=n(e,t.key);if(o<0){if(null===t.left)break;if(n(e,t.left.key)<0){var a=t.left;if(t.left=a.right,a.right=t,null===(t=a).left)break}s.left=t,s=t,t=t.left}else{if(!(o>0))break;if(null===t.right)break;if(n(e,t.right.key)>0){a=t.right;if(t.right=a.left,a.left=t,null===(t=a).right)break}r.right=t,r=t,t=t.right}}return r.right=t.left,s.left=t.right,t.left=i.right,t.right=i.left,t}function jh(e,t,n,i){var r=new Fh(e,t);if(null===n)return r.left=r.right=null,r;var s=i(e,(n=qh(e,n,i)).key);return s<0?(r.left=n.left,r.right=n,n.left=null):s>=0&&(r.right=n.right,r.left=n,n.right=null),r}function Wh(e,t,n){var i=null,r=null;if(t){var s=n((t=qh(e,t,n)).key,e);0===s?(i=t.left,r=t.right):s<0?(r=t.right,t.right=null,i=t):(i=t.left,t.left=null,r=t)}return{left:i,right:r}}function zh(e,t,n,i,r){if(e){i(t+(n?"└── ":"├── ")+r(e)+"\n");var s=t+(n?"    ":"│   ");e.left&&zh(e.left,s,!1,i,r),e.right&&zh(e.right,s,!0,i,r)}}var Bh=function(){function e(e){void 0===e&&(e=Uh),this._root=null,this._size=0,this._comparator=e}return e.prototype.insert=function(e,t){return this._size++,this._root=jh(e,t,this._root,this._comparator)},e.prototype.add=function(e,t){var n=new Fh(e,t);null===this._root&&(n.left=n.right=null,this._size++,this._root=n);var i=this._comparator,r=qh(e,this._root,i),s=i(e,r.key);return 0===s?this._root=r:(s<0?(n.left=r.left,n.right=r,r.left=null):s>0&&(n.right=r.right,n.left=r,r.right=null),this._size++,this._root=n),this._root},e.prototype.remove=function(e){this._root=this._remove(e,this._root,this._comparator)},e.prototype._remove=function(e,t,n){var i;return null===t?null:0===n(e,(t=qh(e,t,n)).key)?(null===t.left?i=t.right:(i=qh(e,t.left,n)).right=t.right,this._size--,i):t},e.prototype.pop=function(){var e=this._root;if(e){for(;e.left;)e=e.left;return this._root=qh(e.key,this._root,this._comparator),this._root=this._remove(e.key,this._root,this._comparator),{key:e.key,data:e.data}}return null},e.prototype.findStatic=function(e){for(var t=this._root,n=this._comparator;t;){var i=n(e,t.key);if(0===i)return t;t=i<0?t.left:t.right}return null},e.prototype.find=function(e){return this._root&&(this._root=qh(e,this._root,this._comparator),0!==this._comparator(e,this._root.key))?null:this._root},e.prototype.contains=function(e){for(var t=this._root,n=this._comparator;t;){var i=n(e,t.key);if(0===i)return!0;t=i<0?t.left:t.right}return!1},e.prototype.forEach=function(e,t){for(var n=this._root,i=[],r=!1;!r;)null!==n?(i.push(n),n=n.left):0!==i.length?(n=i.pop(),e.call(t,n),n=n.right):r=!0;return this},e.prototype.range=function(e,t,n,i){for(var r=[],s=this._comparator,o=this._root;0!==r.length||o;)if(o)r.push(o),o=o.left;else{if(s((o=r.pop()).key,t)>0)break;if(s(o.key,e)>=0&&n.call(i,o))return this;o=o.right}return this},e.prototype.keys=function(){var e=[];return this.forEach((function(t){var n=t.key;return e.push(n)})),e},e.prototype.values=function(){var e=[];return this.forEach((function(t){var n=t.data;return e.push(n)})),e},e.prototype.min=function(){return this._root?this.minNode(this._root).key:null},e.prototype.max=function(){return this._root?this.maxNode(this._root).key:null},e.prototype.minNode=function(e){if(void 0===e&&(e=this._root),e)for(;e.left;)e=e.left;return e},e.prototype.maxNode=function(e){if(void 0===e&&(e=this._root),e)for(;e.right;)e=e.right;return e},e.prototype.at=function(e){for(var t=this._root,n=!1,i=0,r=[];!n;)if(t)r.push(t),t=t.left;else if(r.length>0){if(t=r.pop(),i===e)return t;i++,t=t.right}else n=!0;return null},e.prototype.next=function(e){var t=this._root,n=null;if(e.right){for(n=e.right;n.left;)n=n.left;return n}for(var i=this._comparator;t;){var r=i(e.key,t.key);if(0===r)break;r<0?(n=t,t=t.left):t=t.right}return n},e.prototype.prev=function(e){var t=this._root,n=null;if(null!==e.left){for(n=e.left;n.right;)n=n.right;return n}for(var i=this._comparator;t;){var r=i(e.key,t.key);if(0===r)break;r<0?t=t.left:(n=t,t=t.right)}return n},e.prototype.clear=function(){return this._root=null,this._size=0,this},e.prototype.toList=function(){return function(e){var t=e,n=[],i=!1,r=new Fh(null,null),s=r;for(;!i;)t?(n.push(t),t=t.left):n.length>0?t=(t=s=s.next=n.pop()).right:i=!0;return s.next=null,r.next}(this._root)},e.prototype.load=function(e,t,n){void 0===t&&(t=[]),void 0===n&&(n=!1);var i=e.length,r=this._comparator;if(n&&Gh(e,t,0,i-1,r),null===this._root)this._root=Vh(e,t,0,i),this._size=i;else{var s=function(e,t,n){var i=new Fh(null,null),r=i,s=e,o=t;for(;null!==s&&null!==o;)n(s.key,o.key)<0?(r.next=s,s=s.next):(r.next=o,o=o.next),r=r.next;null!==s?r.next=s:null!==o&&(r.next=o);return i.next}(this.toList(),function(e,t){for(var n=new Fh(null,null),i=n,r=0;r<e.length;r++)i=i.next=new Fh(e[r],t[r]);return i.next=null,n.next}(e,t),r);i=this._size+i,this._root=Hh({head:s},0,i)}return this},e.prototype.isEmpty=function(){return null===this._root},Object.defineProperty(e.prototype,"size",{get:function(){return this._size},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"root",{get:function(){return this._root},enumerable:!0,configurable:!0}),e.prototype.toString=function(e){void 0===e&&(e=function(e){return String(e.key)});var t=[];return zh(this._root,"",!0,(function(e){return t.push(e)}),e),t.join("")},e.prototype.update=function(e,t,n){var i=this._comparator,r=Wh(e,this._root,i),s=r.left,o=r.right;i(e,t)<0?o=jh(t,n,o,i):s=jh(t,n,s,i),this._root=function(e,t,n){return null===t?e:(null===e||((t=qh(e.key,t,n)).left=e),t)}(s,o,i)},e.prototype.split=function(e){return Wh(e,this._root,this._comparator)},e}();function Vh(e,t,n,i){var r=i-n;if(r>0){var s=n+Math.floor(r/2),o=e[s],a=t[s],l=new Fh(o,a);return l.left=Vh(e,t,n,s),l.right=Vh(e,t,s+1,i),l}return null}function Hh(e,t,n){var i=n-t;if(i>0){var r=t+Math.floor(i/2),s=Hh(e,t,r),o=e.head;return o.left=s,e.head=e.head.next,o.right=Hh(e,r+1,n),o}return null}function Gh(e,t,n,i,r){if(!(n>=i)){for(var s=e[n+i>>1],o=n-1,a=i+1;;){do{o++}while(r(e[o],s)<0);do{a--}while(r(e[a],s)>0);if(o>=a)break;var l=e[o];e[o]=e[a],e[a]=l,l=t[o],t[o]=t[a],t[a]=l}Gh(e,t,n,a,r),Gh(e,t,a+1,i,r)}}function $h(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Kh(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function Yh(e,t,n){return t&&Kh(e.prototype,t),n&&Kh(e,n),e}var Jh=function(e,t){return e.ll.x<=t.x&&t.x<=e.ur.x&&e.ll.y<=t.y&&t.y<=e.ur.y},Qh=function(e,t){if(t.ur.x<e.ll.x||e.ur.x<t.ll.x||t.ur.y<e.ll.y||e.ur.y<t.ll.y)return null;var n=e.ll.x<t.ll.x?t.ll.x:e.ll.x,i=e.ur.x<t.ur.x?e.ur.x:t.ur.x;return{ll:{x:n,y:e.ll.y<t.ll.y?t.ll.y:e.ll.y},ur:{x:i,y:e.ur.y<t.ur.y?e.ur.y:t.ur.y}}},Xh=Number.EPSILON;void 0===Xh&&(Xh=Math.pow(2,-52));var Zh=Xh*Xh,eu=function(e,t){if(-Xh<e&&e<Xh&&-Xh<t&&t<Xh)return 0;var n=e-t;return n*n<Zh*e*t?0:e<t?-1:1},tu=function(){function e(){$h(this,e),this.reset()}return Yh(e,[{key:"reset",value:function(){this.xRounder=new nu,this.yRounder=new nu}},{key:"round",value:function(e,t){return{x:this.xRounder.round(e),y:this.yRounder.round(t)}}}]),e}(),nu=function(){function e(){$h(this,e),this.tree=new Bh,this.round(0)}return Yh(e,[{key:"round",value:function(e){var t=this.tree.add(e),n=this.tree.prev(t);if(null!==n&&0===eu(t.key,n.key))return this.tree.remove(e),n.key;var i=this.tree.next(t);return null!==i&&0===eu(t.key,i.key)?(this.tree.remove(e),i.key):e}}]),e}(),iu=new tu,ru=function(e,t){return e.x*t.y-e.y*t.x},su=function(e,t){return e.x*t.x+e.y*t.y},ou=function(e,t,n){var i={x:t.x-e.x,y:t.y-e.y},r={x:n.x-e.x,y:n.y-e.y},s=ru(i,r);return eu(s,0)},au=function(e){return Math.sqrt(su(e,e))},lu=function(e,t,n){var i={x:t.x-e.x,y:t.y-e.y},r={x:n.x-e.x,y:n.y-e.y};return su(r,i)/au(r)/au(i)},cu=function(e,t,n){return 0===t.y?null:{x:e.x+t.x/t.y*(n-e.y),y:n}},hu=function(e,t,n){return 0===t.x?null:{x:n,y:e.y+t.y/t.x*(n-e.x)}},uu=function(){function e(t,n){$h(this,e),void 0===t.events?t.events=[this]:t.events.push(this),this.point=t,this.isLeft=n}return Yh(e,null,[{key:"compare",value:function(t,n){var i=e.comparePoints(t.point,n.point);return 0!==i?i:(t.point!==n.point&&t.link(n),t.isLeft!==n.isLeft?t.isLeft?1:-1:pu.compare(t.segment,n.segment))}},{key:"comparePoints",value:function(e,t){return e.x<t.x?-1:e.x>t.x?1:e.y<t.y?-1:e.y>t.y?1:0}}]),Yh(e,[{key:"link",value:function(e){if(e.point===this.point)throw new Error("Tried to link already linked events");for(var t=e.point.events,n=0,i=t.length;n<i;n++){var r=t[n];this.point.events.push(r),r.point=this.point}this.checkForConsuming()}},{key:"checkForConsuming",value:function(){for(var e=this.point.events.length,t=0;t<e;t++){var n=this.point.events[t];if(void 0===n.segment.consumedBy)for(var i=t+1;i<e;i++){var r=this.point.events[i];void 0===r.consumedBy&&(n.otherSE.point.events===r.otherSE.point.events&&n.segment.consume(r.segment))}}}},{key:"getAvailableLinkedEvents",value:function(){for(var e=[],t=0,n=this.point.events.length;t<n;t++){var i=this.point.events[t];i!==this&&!i.segment.ringOut&&i.segment.isInResult()&&e.push(i)}return e}},{key:"getLeftmostComparator",value:function(e){var t=this,n=new Map,i=function(i){var r,s,o,a,l,c=i.otherSE;n.set(i,{sine:(r=t.point,s=e.point,o=c.point,a={x:s.x-r.x,y:s.y-r.y},l={x:o.x-r.x,y:o.y-r.y},ru(l,a)/au(l)/au(a)),cosine:lu(t.point,e.point,c.point)})};return function(e,t){n.has(e)||i(e),n.has(t)||i(t);var r=n.get(e),s=r.sine,o=r.cosine,a=n.get(t),l=a.sine,c=a.cosine;return s>=0&&l>=0?o<c?1:o>c?-1:0:s<0&&l<0?o<c?-1:o>c?1:0:l<s?-1:l>s?1:0}}}]),e}(),du=0,pu=function(){function e(t,n,i,r){$h(this,e),this.id=++du,this.leftSE=t,t.segment=this,t.otherSE=n,this.rightSE=n,n.segment=this,n.otherSE=t,this.rings=i,this.windings=r}return Yh(e,null,[{key:"compare",value:function(e,t){var n=e.leftSE.point.x,i=t.leftSE.point.x,r=e.rightSE.point.x,s=t.rightSE.point.x;if(s<n)return 1;if(r<i)return-1;var o=e.leftSE.point.y,a=t.leftSE.point.y,l=e.rightSE.point.y,c=t.rightSE.point.y;if(n<i){if(a<o&&a<l)return 1;if(a>o&&a>l)return-1;var h=e.comparePoint(t.leftSE.point);if(h<0)return 1;if(h>0)return-1;var u=t.comparePoint(e.rightSE.point);return 0!==u?u:-1}if(n>i){if(o<a&&o<c)return-1;if(o>a&&o>c)return 1;var d=t.comparePoint(e.leftSE.point);if(0!==d)return d;var p=e.comparePoint(t.rightSE.point);return p<0?1:p>0?-1:1}if(o<a)return-1;if(o>a)return 1;if(r<s){var f=t.comparePoint(e.rightSE.point);if(0!==f)return f}if(r>s){var _=e.comparePoint(t.rightSE.point);if(_<0)return 1;if(_>0)return-1}if(r!==s){var g=l-o,m=r-n,y=c-a,v=s-i;if(g>m&&y<v)return 1;if(g<m&&y>v)return-1}return r>s?1:r<s||l<c?-1:l>c?1:e.id<t.id?-1:e.id>t.id?1:0}}]),Yh(e,[{key:"replaceRightSE",value:function(e){this.rightSE=e,this.rightSE.segment=this,this.rightSE.otherSE=this.leftSE,this.leftSE.otherSE=this.rightSE}},{key:"bbox",value:function(){var e=this.leftSE.point.y,t=this.rightSE.point.y;return{ll:{x:this.leftSE.point.x,y:e<t?e:t},ur:{x:this.rightSE.point.x,y:e>t?e:t}}}},{key:"vector",value:function(){return{x:this.rightSE.point.x-this.leftSE.point.x,y:this.rightSE.point.y-this.leftSE.point.y}}},{key:"isAnEndpoint",value:function(e){return e.x===this.leftSE.point.x&&e.y===this.leftSE.point.y||e.x===this.rightSE.point.x&&e.y===this.rightSE.point.y}},{key:"comparePoint",value:function(e){if(this.isAnEndpoint(e))return 0;var t=this.leftSE.point,n=this.rightSE.point,i=this.vector();if(t.x===n.x)return e.x===t.x?0:e.x<t.x?1:-1;var r=(e.y-t.y)/i.y,s=t.x+r*i.x;if(e.x===s)return 0;var o=(e.x-t.x)/i.x,a=t.y+o*i.y;return e.y===a?0:e.y<a?-1:1}},{key:"getIntersection",value:function(e){var t=this.bbox(),n=e.bbox(),i=Qh(t,n);if(null===i)return null;var r=this.leftSE.point,s=this.rightSE.point,o=e.leftSE.point,a=e.rightSE.point,l=Jh(t,o)&&0===this.comparePoint(o),c=Jh(n,r)&&0===e.comparePoint(r),h=Jh(t,a)&&0===this.comparePoint(a),u=Jh(n,s)&&0===e.comparePoint(s);if(c&&l)return u&&!h?s:!u&&h?a:null;if(c)return h&&r.x===a.x&&r.y===a.y?null:r;if(l)return u&&s.x===o.x&&s.y===o.y?null:o;if(u&&h)return null;if(u)return s;if(h)return a;var d=function(e,t,n,i){if(0===t.x)return hu(n,i,e.x);if(0===i.x)return hu(e,t,n.x);if(0===t.y)return cu(n,i,e.y);if(0===i.y)return cu(e,t,n.y);var r=ru(t,i);if(0==r)return null;var s={x:n.x-e.x,y:n.y-e.y},o=ru(s,t)/r,a=ru(s,i)/r;return{x:(e.x+a*t.x+(n.x+o*i.x))/2,y:(e.y+a*t.y+(n.y+o*i.y))/2}}(r,this.vector(),o,e.vector());return null===d?null:Jh(i,d)?iu.round(d.x,d.y):null}},{key:"split",value:function(t){var n=[],i=void 0!==t.events,r=new uu(t,!0),s=new uu(t,!1),o=this.rightSE;this.replaceRightSE(s),n.push(s),n.push(r);var a=new e(r,o,this.rings.slice(),this.windings.slice());return uu.comparePoints(a.leftSE.point,a.rightSE.point)>0&&a.swapEvents(),uu.comparePoints(this.leftSE.point,this.rightSE.point)>0&&this.swapEvents(),i&&(r.checkForConsuming(),s.checkForConsuming()),n}},{key:"swapEvents",value:function(){var e=this.rightSE;this.rightSE=this.leftSE,this.leftSE=e,this.leftSE.isLeft=!0,this.rightSE.isLeft=!1;for(var t=0,n=this.windings.length;t<n;t++)this.windings[t]*=-1}},{key:"consume",value:function(t){for(var n=this,i=t;n.consumedBy;)n=n.consumedBy;for(;i.consumedBy;)i=i.consumedBy;var r=e.compare(n,i);if(0!==r){if(r>0){var s=n;n=i,i=s}if(n.prev===i){var o=n;n=i,i=o}for(var a=0,l=i.rings.length;a<l;a++){var c=i.rings[a],h=i.windings[a],u=n.rings.indexOf(c);-1===u?(n.rings.push(c),n.windings.push(h)):n.windings[u]+=h}i.rings=null,i.windings=null,i.consumedBy=n,i.leftSE.consumedBy=n.leftSE,i.rightSE.consumedBy=n.rightSE}}},{key:"prevInResult",value:function(){return void 0!==this._prevInResult||(this.prev?this.prev.isInResult()?this._prevInResult=this.prev:this._prevInResult=this.prev.prevInResult():this._prevInResult=null),this._prevInResult}},{key:"beforeState",value:function(){if(void 0!==this._beforeState)return this._beforeState;if(this.prev){var e=this.prev.consumedBy||this.prev;this._beforeState=e.afterState()}else this._beforeState={rings:[],windings:[],multiPolys:[]};return this._beforeState}},{key:"afterState",value:function(){if(void 0!==this._afterState)return this._afterState;var e=this.beforeState();this._afterState={rings:e.rings.slice(0),windings:e.windings.slice(0),multiPolys:[]};for(var t=this._afterState.rings,n=this._afterState.windings,i=this._afterState.multiPolys,r=0,s=this.rings.length;r<s;r++){var o=this.rings[r],a=this.windings[r],l=t.indexOf(o);-1===l?(t.push(o),n.push(a)):n[l]+=a}for(var c=[],h=[],u=0,d=t.length;u<d;u++)if(0!==n[u]){var p=t[u],f=p.poly;if(-1===h.indexOf(f))if(p.isExterior)c.push(f);else{-1===h.indexOf(f)&&h.push(f);var _=c.indexOf(p.poly);-1!==_&&c.splice(_,1)}}for(var g=0,m=c.length;g<m;g++){var y=c[g].multiPoly;-1===i.indexOf(y)&&i.push(y)}return this._afterState}},{key:"isInResult",value:function(){if(this.consumedBy)return!1;if(void 0!==this._isInResult)return this._isInResult;var e=this.beforeState().multiPolys,t=this.afterState().multiPolys;switch(Iu.type){case"union":var n=0===e.length,i=0===t.length;this._isInResult=n!==i;break;case"intersection":var r,s;e.length<t.length?(r=e.length,s=t.length):(r=t.length,s=e.length),this._isInResult=s===Iu.numMultiPolys&&r<s;break;case"xor":var o=Math.abs(e.length-t.length);this._isInResult=o%2==1;break;case"difference":var a=function(e){return 1===e.length&&e[0].isSubject};this._isInResult=a(e)!==a(t);break;default:throw new Error("Unrecognized operation type found ".concat(Iu.type))}return this._isInResult}}],[{key:"fromRing",value:function(t,n,i){var r,s,o,a=uu.comparePoints(t,n);if(a<0)r=t,s=n,o=1;else{if(!(a>0))throw new Error("Tried to create degenerate segment at [".concat(t.x,", ").concat(t.y,"]"));r=n,s=t,o=-1}return new e(new uu(r,!0),new uu(s,!1),[i],[o])}}]),e}(),fu=function(){function e(t,n,i){if($h(this,e),!Array.isArray(t)||0===t.length)throw new Error("Input geometry is not a valid Polygon or MultiPolygon");if(this.poly=n,this.isExterior=i,this.segments=[],"number"!=typeof t[0][0]||"number"!=typeof t[0][1])throw new Error("Input geometry is not a valid Polygon or MultiPolygon");var r=iu.round(t[0][0],t[0][1]);this.bbox={ll:{x:r.x,y:r.y},ur:{x:r.x,y:r.y}};for(var s=r,o=1,a=t.length;o<a;o++){if("number"!=typeof t[o][0]||"number"!=typeof t[o][1])throw new Error("Input geometry is not a valid Polygon or MultiPolygon");var l=iu.round(t[o][0],t[o][1]);l.x===s.x&&l.y===s.y||(this.segments.push(pu.fromRing(s,l,this)),l.x<this.bbox.ll.x&&(this.bbox.ll.x=l.x),l.y<this.bbox.ll.y&&(this.bbox.ll.y=l.y),l.x>this.bbox.ur.x&&(this.bbox.ur.x=l.x),l.y>this.bbox.ur.y&&(this.bbox.ur.y=l.y),s=l)}r.x===s.x&&r.y===s.y||this.segments.push(pu.fromRing(s,r,this))}return Yh(e,[{key:"getSweepEvents",value:function(){for(var e=[],t=0,n=this.segments.length;t<n;t++){var i=this.segments[t];e.push(i.leftSE),e.push(i.rightSE)}return e}}]),e}(),_u=function(){function e(t,n){if($h(this,e),!Array.isArray(t))throw new Error("Input geometry is not a valid Polygon or MultiPolygon");this.exteriorRing=new fu(t[0],this,!0),this.bbox={ll:{x:this.exteriorRing.bbox.ll.x,y:this.exteriorRing.bbox.ll.y},ur:{x:this.exteriorRing.bbox.ur.x,y:this.exteriorRing.bbox.ur.y}},this.interiorRings=[];for(var i=1,r=t.length;i<r;i++){var s=new fu(t[i],this,!1);s.bbox.ll.x<this.bbox.ll.x&&(this.bbox.ll.x=s.bbox.ll.x),s.bbox.ll.y<this.bbox.ll.y&&(this.bbox.ll.y=s.bbox.ll.y),s.bbox.ur.x>this.bbox.ur.x&&(this.bbox.ur.x=s.bbox.ur.x),s.bbox.ur.y>this.bbox.ur.y&&(this.bbox.ur.y=s.bbox.ur.y),this.interiorRings.push(s)}this.multiPoly=n}return Yh(e,[{key:"getSweepEvents",value:function(){for(var e=this.exteriorRing.getSweepEvents(),t=0,n=this.interiorRings.length;t<n;t++)for(var i=this.interiorRings[t].getSweepEvents(),r=0,s=i.length;r<s;r++)e.push(i[r]);return e}}]),e}(),gu=function(){function e(t,n){if($h(this,e),!Array.isArray(t))throw new Error("Input geometry is not a valid Polygon or MultiPolygon");try{"number"==typeof t[0][0][0]&&(t=[t])}catch(o){}this.polys=[],this.bbox={ll:{x:Number.POSITIVE_INFINITY,y:Number.POSITIVE_INFINITY},ur:{x:Number.NEGATIVE_INFINITY,y:Number.NEGATIVE_INFINITY}};for(var i=0,r=t.length;i<r;i++){var s=new _u(t[i],this);s.bbox.ll.x<this.bbox.ll.x&&(this.bbox.ll.x=s.bbox.ll.x),s.bbox.ll.y<this.bbox.ll.y&&(this.bbox.ll.y=s.bbox.ll.y),s.bbox.ur.x>this.bbox.ur.x&&(this.bbox.ur.x=s.bbox.ur.x),s.bbox.ur.y>this.bbox.ur.y&&(this.bbox.ur.y=s.bbox.ur.y),this.polys.push(s)}this.isSubject=n}return Yh(e,[{key:"getSweepEvents",value:function(){for(var e=[],t=0,n=this.polys.length;t<n;t++)for(var i=this.polys[t].getSweepEvents(),r=0,s=i.length;r<s;r++)e.push(i[r]);return e}}]),e}(),mu=function(){function e(t){$h(this,e),this.events=t;for(var n=0,i=t.length;n<i;n++)t[n].segment.ringOut=this;this.poly=null}return Yh(e,null,[{key:"factory",value:function(t){for(var n=[],i=0,r=t.length;i<r;i++){var s=t[i];if(s.isInResult()&&!s.ringOut){for(var o=null,a=s.leftSE,l=s.rightSE,c=[a],h=a.point,u=[];o=a,a=l,c.push(a),a.point!==h;)for(;;){var d=a.getAvailableLinkedEvents();if(0===d.length){var p=c[0].point,f=c[c.length-1].point;throw new Error("Unable to complete output ring starting at [".concat(p.x,",")+" ".concat(p.y,"]. Last matching segment found ends at")+" [".concat(f.x,", ").concat(f.y,"]."))}if(1===d.length){l=d[0].otherSE;break}for(var _=null,g=0,m=u.length;g<m;g++)if(u[g].point===a.point){_=g;break}if(null===_){u.push({index:c.length,point:a.point});var y=a.getLeftmostComparator(o);l=d.sort(y)[0].otherSE;break}var v=u.splice(_)[0],w=c.splice(v.index);w.unshift(w[0].otherSE),n.push(new e(w.reverse()))}n.push(new e(c))}}return n}}]),Yh(e,[{key:"getGeom",value:function(){for(var e=this.events[0].point,t=[e],n=1,i=this.events.length-1;n<i;n++){var r=this.events[n].point,s=this.events[n+1].point;0!==ou(r,e,s)&&(t.push(r),e=r)}if(1===t.length)return null;var o=t[0],a=t[1];0===ou(o,e,a)&&t.shift(),t.push(t[0]);for(var l=this.isExteriorRing()?1:-1,c=this.isExteriorRing()?0:t.length-1,h=this.isExteriorRing()?t.length:-1,u=[],d=c;d!=h;d+=l)u.push([t[d].x,t[d].y]);return u}},{key:"isExteriorRing",value:function(){if(void 0===this._isExteriorRing){var e=this.enclosingRing();this._isExteriorRing=!e||!e.isExteriorRing()}return this._isExteriorRing}},{key:"enclosingRing",value:function(){return void 0===this._enclosingRing&&(this._enclosingRing=this._calcEnclosingRing()),this._enclosingRing}},{key:"_calcEnclosingRing",value:function(){for(var e=this.events[0],t=1,n=this.events.length;t<n;t++){var i=this.events[t];uu.compare(e,i)>0&&(e=i)}for(var r=e.segment.prevInResult(),s=r?r.prevInResult():null;;){if(!r)return null;if(!s)return r.ringOut;if(s.ringOut!==r.ringOut)return s.ringOut.enclosingRing()!==r.ringOut?r.ringOut:r.ringOut.enclosingRing();r=s.prevInResult(),s=r?r.prevInResult():null}}}]),e}(),yu=function(){function e(t){$h(this,e),this.exteriorRing=t,t.poly=this,this.interiorRings=[]}return Yh(e,[{key:"addInterior",value:function(e){this.interiorRings.push(e),e.poly=this}},{key:"getGeom",value:function(){var e=[this.exteriorRing.getGeom()];if(null===e[0])return null;for(var t=0,n=this.interiorRings.length;t<n;t++){var i=this.interiorRings[t].getGeom();null!==i&&e.push(i)}return e}}]),e}(),vu=function(){function e(t){$h(this,e),this.rings=t,this.polys=this._composePolys(t)}return Yh(e,[{key:"getGeom",value:function(){for(var e=[],t=0,n=this.polys.length;t<n;t++){var i=this.polys[t].getGeom();null!==i&&e.push(i)}return e}},{key:"_composePolys",value:function(e){for(var t=[],n=0,i=e.length;n<i;n++){var r=e[n];if(!r.poly)if(r.isExteriorRing())t.push(new yu(r));else{var s=r.enclosingRing();s.poly||t.push(new yu(s)),s.poly.addInterior(r)}}return t}}]),e}(),wu=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:pu.compare;$h(this,e),this.queue=t,this.tree=new Bh(n),this.segments=[]}return Yh(e,[{key:"process",value:function(e){var t=e.segment,n=[];if(e.consumedBy)return e.isLeft?this.queue.remove(e.otherSE):this.tree.remove(t),n;var i=e.isLeft?this.tree.insert(t):this.tree.find(t);if(!i)throw new Error("Unable to find segment #".concat(t.id," ")+"[".concat(t.leftSE.point.x,", ").concat(t.leftSE.point.y,"] -> ")+"[".concat(t.rightSE.point.x,", ").concat(t.rightSE.point.y,"] ")+"in SweepLine tree. Please submit a bug report.");for(var r=i,s=i,o=void 0,a=void 0;void 0===o;)null===(r=this.tree.prev(r))?o=null:void 0===r.key.consumedBy&&(o=r.key);for(;void 0===a;)null===(s=this.tree.next(s))?a=null:void 0===s.key.consumedBy&&(a=s.key);if(e.isLeft){var l=null;if(o){var c=o.getIntersection(t);if(null!==c&&(t.isAnEndpoint(c)||(l=c),!o.isAnEndpoint(c)))for(var h=this._splitSafely(o,c),u=0,d=h.length;u<d;u++)n.push(h[u])}var p=null;if(a){var f=a.getIntersection(t);if(null!==f&&(t.isAnEndpoint(f)||(p=f),!a.isAnEndpoint(f)))for(var _=this._splitSafely(a,f),g=0,m=_.length;g<m;g++)n.push(_[g])}if(null!==l||null!==p){var y=null;if(null===l)y=p;else if(null===p)y=l;else{y=uu.comparePoints(l,p)<=0?l:p}this.queue.remove(t.rightSE),n.push(t.rightSE);for(var v=t.split(y),w=0,b=v.length;w<b;w++)n.push(v[w])}n.length>0?(this.tree.remove(t),n.push(e)):(this.segments.push(t),t.prev=o)}else{if(o&&a){var C=o.getIntersection(a);if(null!==C){if(!o.isAnEndpoint(C))for(var I=this._splitSafely(o,C),k=0,E=I.length;k<E;k++)n.push(I[k]);if(!a.isAnEndpoint(C))for(var T=this._splitSafely(a,C),S=0,x=T.length;S<x;S++)n.push(T[S])}}this.tree.remove(t)}return n}},{key:"_splitSafely",value:function(e,t){this.tree.remove(e);var n=e.rightSE;this.queue.remove(n);var i=e.split(t);return i.push(n),void 0===e.consumedBy&&this.tree.insert(e),i}}]),e}(),bu="undefined"!=typeof process&&{}.POLYGON_CLIPPING_MAX_QUEUE_SIZE||1e6,Cu="undefined"!=typeof process&&{}.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS||1e6,Iu=new(function(){function e(){$h(this,e)}return Yh(e,[{key:"run",value:function(e,t,n){Iu.type=e,iu.reset();for(var i=[new gu(t,!0)],r=0,s=n.length;r<s;r++)i.push(new gu(n[r],!1));if(Iu.numMultiPolys=i.length,"difference"===Iu.type)for(var o=i[0],a=1;a<i.length;)null!==Qh(i[a].bbox,o.bbox)?a++:i.splice(a,1);if("intersection"===Iu.type)for(var l=0,c=i.length;l<c;l++)for(var h=i[l],u=l+1,d=i.length;u<d;u++)if(null===Qh(h.bbox,i[u].bbox))return[];for(var p=new Bh(uu.compare),f=0,_=i.length;f<_;f++)for(var g=i[f].getSweepEvents(),m=0,y=g.length;m<y;m++)if(p.insert(g[m]),p.size>bu)throw new Error("Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.");for(var v=new wu(p),w=p.size,b=p.pop();b;){var C=b.key;if(p.size===w){var I=C.segment;throw new Error("Unable to pop() ".concat(C.isLeft?"left":"right"," SweepEvent ")+"[".concat(C.point.x,", ").concat(C.point.y,"] from segment #").concat(I.id," ")+"[".concat(I.leftSE.point.x,", ").concat(I.leftSE.point.y,"] -> ")+"[".concat(I.rightSE.point.x,", ").concat(I.rightSE.point.y,"] from queue. ")+"Please file a bug report.")}if(p.size>bu)throw new Error("Infinite loop when passing sweep line over endpoints (queue size too big). Please file a bug report.");if(v.segments.length>Cu)throw new Error("Infinite loop when passing sweep line over endpoints (too many sweep line segments). Please file a bug report.");for(var k=v.process(C),E=0,T=k.length;E<T;E++){var S=k[E];void 0===S.consumedBy&&p.insert(S)}w=p.size,b=p.pop()}iu.reset();var x=mu.factory(v.segments);return new vu(x).getGeom()}}]),e}()),ku={union:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return Iu.run("union",e,n)},intersection:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return Iu.run("intersection",e,n)},xor:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return Iu.run("xor",e,n)},difference:function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return Iu.run("difference",e,n)}},Eu={exports:{}},Tu=function(e,t){this.p1=e,this.p2=t};Tu.prototype.rise=function(){return this.p2[1]-this.p1[1]},Tu.prototype.run=function(){return this.p2[0]-this.p1[0]},Tu.prototype.slope=function(){return this.rise()/this.run()},Tu.prototype.yIntercept=function(){return this.p1[1]-this.p1[0]*this.slope(this.p1,this.p2)},Tu.prototype.isVertical=function(){return!isFinite(this.slope())},Tu.prototype.isHorizontal=function(){return this.p1[1]==this.p2[1]},Tu.prototype._perpendicularDistanceHorizontal=function(e){return Math.abs(this.p1[1]-e[1])},Tu.prototype._perpendicularDistanceVertical=function(e){return Math.abs(this.p1[0]-e[0])},Tu.prototype._perpendicularDistanceHasSlope=function(e){var t=this.slope(),n=this.yIntercept();return Math.abs(t*e[0]-e[1]+n)/Math.sqrt(Math.pow(t,2)+1)},Tu.prototype.perpendicularDistance=function(e){return this.isVertical()?this._perpendicularDistanceVertical(e):this.isHorizontal()?this._perpendicularDistanceHorizontal(e):this._perpendicularDistanceHasSlope(e)};var Su=Tu,xu=function(e,t){for(var n=0,i=0,r=1;r<=e.length-2;r++){var s=new Su(e[0],e[e.length-1]).perpendicularDistance(e[r]);s>n&&(i=r,n=s)}if(n>t)var o=xu(e.slice(0,i),t),a=xu(e.slice(i,e.length),t),l=o.concat(a);else l=e.length>1?[e[0],e[e.length-1]]:[e[0]];return l},Ru=xu;!function(e){var t=Ru;function n(t,n){var i=t.geometry,r=i.type;if("LineString"===r)i.coordinates=e.exports.simplify(i.coordinates,n);else if("Polygon"===r||"MultiLineString"===r)for(var s=0;s<i.coordinates.length;s++)i.coordinates[s]=e.exports.simplify(i.coordinates[s],n);else if("MultiPolygon"===r)for(var o=0;o<i.coordinates.length;o++)for(var a=0;a<i.coordinates[o].length;a++)i.coordinates[o][a]=e.exports.simplify(i.coordinates[o][a],n);return t}e.exports=function(e,t,i){return i||(e=JSON.parse(JSON.stringify(e))),e.features?function(e,t){for(var i=0;i<e.features.length;i++)e.features[i]=n(e.features[i],t);return e}(e,t):e.type&&"Feature"===e.type?n(e,t):new Error("FeatureCollection or individual Feature required")},e.exports.simplify=function(e,n){return t(e,n)}}(Eu);var Pu=Eu.exports;export{Zl as A,Ll as B,On as C,An as D,U as E,F,Fl as G,Zc as H,zl as I,Bl as J,Vl as K,Wl as L,fh as M,gh as N,at as O,j as P,p as a,f as b,g as c,ku as d,Pu as e,L as f,_ as g,z as h,V as i,m as j,Lh as k,Ql as l,th as m,Ai as n,v as o,Gl as p,$l as q,Al as r,B as s,W as t,y as u,Pn as v,Nn as w,Ml as x,eh as y,Xc as z};
